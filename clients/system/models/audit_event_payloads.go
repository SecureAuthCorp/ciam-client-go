...
type AuditEventPayloads struct {
	...
	// bruteforce updated
	BruteforceUpdated *BruteForceLimit `json:"bruteforce_updated,omitempty" yaml:"bruteforce_updated,omitempty"`
	...
	OrganizationCreated *Org `json:"organization_created,omitempty" yaml:"organization_created,omitempty"`

	// organization deleted
	OrganizationDeleted *Org `json:"organization_deleted,omitempty" yaml:"organization_deleted,omitempty"`

	// organization updated
	OrganizationUpdated *Org `json:"organization_updated,omitempty" yaml:"organization_updated,omitempty"`
	...
	// password accepted
	PasswordAccepted *UserIDAndIdentifierPayload `json:"password_accepted,omitempty" yaml:"password_accepted,omitempty"`

	// password confirmed
	PasswordConfirmed *UserIDAndIdentifierPayload `json:"password_confirmed,omitempty" yaml:"password_confirmed,omitempty"`

	// password rejected
	PasswordRejected *UserIDAndIdentifierPayload `json:"password_rejected,omitempty" yaml:"password_rejected,omitempty"`

	// password requested
	PasswordRequested *UserIDAndIdentifierPayload `json:"password_requested,omitempty" yaml:"password_requested,omitempty"`
	...
	// totp reset completed
	TotpResetCompleted *UserIDAndIdentifierPayload `json:"totp_reset_completed,omitempty" yaml:"totp_reset_completed,omitempty"`
	...
	// webauthn add completed
	WebauthnAddCompleted *UserIDAndIdentifierPayload `json:"webauthn_add_completed,omitempty" yaml:"webauthn_add_completed,omitempty"`

	// webauthn add requested
	WebauthnAddRequested *UserIDAndIdentifierPayload `json:"webauthn_add_requested,omitempty" yaml:"webauthn_add_requested,omitempty"`
}
...
func (m *AuditEventPayloads) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTotpResetCompleted(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateTotpResetRequested(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateWebauthnAddCompleted(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateWebauthnAddRequested(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AuditEventPayloads) validateTotpResetCompleted(formats strfmt.Registry) error {
	if swag.IsZero(m.TotpResetCompleted) { // not required
		return nil
	}

	if m.TotpResetCompleted != nil {
		if err := m.TotpResetCompleted.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("totp_reset_completed")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("totp_reset_completed")
			}
			return err
		}
	}
...
func (m *AuditEventPayloads) validateTotpResetRequested(formats strfmt.Registry) error {
	if swag.IsZero(m.TotpResetRequested) { // not required
		return nil
	}

	if m.TotpResetRequested != nil {
		if err := m.TotpResetRequested.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("totp_reset_requested")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("totp_reset_requested")
			}
			return err
		}
	}
...
func (m *AuditEventPayloads) validateWebauthnAddCompleted(formats strfmt.Registry) error {
	if swag.IsZero(m.WebauthnAddCompleted) { // not required
		return nil
	}

	if m.WebauthnAddCompleted != nil {
		if err := m.WebauthnAddCompleted.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("webauthn_add_completed")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("webauthn_add_completed")
			}
			return err
		}
	}
...
func (m *AuditEventPayloads) validateWebauthnAddRequested(formats strfmt.Registry) error {
	if swag.IsZero(m.WebauthnAddRequested) { // not required
		return nil
	}

	if m.WebauthnAddRequested != nil {
		if err := m.WebauthnAddRequested.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("webauthn_add_requested")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("webauthn_add_requested")
			}
			return err
		}
	}
...
func (m *AuditEventPayloads) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTotpResetCompleted(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateTotpResetRequested(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateWebauthnAddCompleted(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateWebauthnAddRequested(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AuditEventPayloads) contextValidateTotpResetCompleted(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TotpResetCompleted != nil {
		...
		if err := m.TotpResetCompleted.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("totp_reset_completed")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("totp_reset_completed")
...
func (m *AuditEventPayloads) contextValidateTotpResetRequested(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TotpResetRequested != nil {
		...
		if err := m.TotpResetRequested.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("totp_reset_requested")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("totp_reset_requested")
...
func (m *AuditEventPayloads) contextValidateWebauthnAddCompleted(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.WebauthnAddCompleted != nil {
		...
		if err := m.WebauthnAddCompleted.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("webauthn_add_completed")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("webauthn_add_completed")
...
func (m *AuditEventPayloads) contextValidateWebauthnAddRequested(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.WebauthnAddRequested != nil {
		...
		if err := m.WebauthnAddRequested.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("webauthn_add_requested")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("webauthn_add_requested")
