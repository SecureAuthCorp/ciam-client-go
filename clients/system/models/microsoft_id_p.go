...
// MicrosoftIDP microsoft ID p
//
// swagger:model MicrosoftIDP
type MicrosoftIDP struct {
	...
	// credentials
	Credentials *MicrosoftCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *MicrosoftSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this microsoft ID p
func (m *MicrosoftIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MicrosoftIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateJit(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this microsoft ID p based on the context it is used
func (m *MicrosoftIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MicrosoftIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MicrosoftIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MicrosoftIDP) UnmarshalBinary(b []byte) error {
	var res MicrosoftIDP
