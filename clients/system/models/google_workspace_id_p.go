...
// GoogleWorkspaceIDP google workspace ID p
//
// swagger:model GoogleWorkspaceIDP
type GoogleWorkspaceIDP struct {
	...
	// credentials
	Credentials *GoogleWorkspaceCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *GoogleWorkspaceSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this google workspace ID p
func (m *GoogleWorkspaceIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GoogleWorkspaceIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateJit(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this google workspace ID p based on the context it is used
func (m *GoogleWorkspaceIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GoogleWorkspaceIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleWorkspaceIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GoogleWorkspaceIDP) UnmarshalBinary(b []byte) error {
	var res GoogleWorkspaceIDP
