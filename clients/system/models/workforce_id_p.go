...
// WorkforceIDP workforce ID p
//
// swagger:model WorkforceIDP
type WorkforceIDP struct {
	...
	// credentials
	Credentials WorkforceCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *WorkforceSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this workforce ID p
func (m *WorkforceIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WorkforceIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateJit(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *WorkforceIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this workforce ID p based on the context it is used
func (m *WorkforceIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WorkforceIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WorkforceIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WorkforceIDP) UnmarshalBinary(b []byte) error {
	var res WorkforceIDP
