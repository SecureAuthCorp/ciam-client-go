...
// LinkedInIDP linked in ID p
//
// swagger:model LinkedInIDP
type LinkedInIDP struct {
	...
	// credentials
	Credentials *LinkedInCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *LinkedInSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this linked in ID p
func (m *LinkedInIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LinkedInIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateJit(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *LinkedInIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this linked in ID p based on the context it is used
func (m *LinkedInIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LinkedInIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LinkedInIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LinkedInIDP) UnmarshalBinary(b []byte) error {
	var res LinkedInIDP
