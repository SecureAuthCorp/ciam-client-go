...
var accessRequestDataAuthenticationMechanismsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		accessRequestDataAuthenticationMechanismsItemsEnum = append(accessRequestDataAuthenticationMechanismsItemsEnum, v)
	}
}

func (m *AccessRequestData) validateAuthenticationMechanismsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, accessRequestDataAuthenticationMechanismsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *AccessRequestData) validateAuthenticationMechanisms(formats strfmt.Registry) error {
