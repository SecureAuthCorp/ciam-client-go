...
// SAMLAssertionDeniedPayload s a m l assertion denied payload
//
// swagger:model SAMLAssertionDeniedPayload
type SAMLAssertionDeniedPayload struct {
	...
	// idp initiated
	IdpInitiated bool `json:"idp_initiated,omitempty" yaml:"idp_initiated,omitempty"`
	...
	// service provider id
	ServiceProviderID string `json:"service_provider_id,omitempty" yaml:"service_provider_id,omitempty"`
...
// Validate validates this s a m l assertion denied payload
func (m *SAMLAssertionDeniedPayload) Validate(formats strfmt.Registry) error {
	var res []error
...
var sAMLAssertionDeniedPayloadAuthenticationMechanismsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sAMLAssertionDeniedPayloadAuthenticationMechanismsItemsEnum = append(sAMLAssertionDeniedPayloadAuthenticationMechanismsItemsEnum, v)
	}
}

func (m *SAMLAssertionDeniedPayload) validateAuthenticationMechanismsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sAMLAssertionDeniedPayloadAuthenticationMechanismsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SAMLAssertionDeniedPayload) validateAuthenticationMechanisms(formats strfmt.Registry) error {
...
func (m *SAMLAssertionDeniedPayload) validateRiskEngineContext(formats strfmt.Registry) error {
...
var sAMLAssertionDeniedPayloadTypeTokenEndpointAuthnMethodPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sAMLAssertionDeniedPayloadTypeTokenEndpointAuthnMethodPropEnum = append(sAMLAssertionDeniedPayloadTypeTokenEndpointAuthnMethodPropEnum, v)
	}
}

const (

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretBasic captures enum value "client_secret_basic"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretBasic string = "client_secret_basic"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretPost captures enum value "client_secret_post"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretPost string = "client_secret_post"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretJwt captures enum value "client_secret_jwt"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodClientSecretJwt string = "client_secret_jwt"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodPrivateKeyJwt captures enum value "private_key_jwt"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodPrivateKeyJwt string = "private_key_jwt"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodSelfSignedTLSClientAuth captures enum value "self_signed_tls_client_auth"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodSelfSignedTLSClientAuth string = "self_signed_tls_client_auth"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodTLSClientAuth captures enum value "tls_client_auth"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodTLSClientAuth string = "tls_client_auth"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodNone captures enum value "none"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodNone string = "none"

	// SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodUnspecified captures enum value "unspecified"
	SAMLAssertionDeniedPayloadTokenEndpointAuthnMethodUnspecified string = "unspecified"
)

// prop value enum
func (m *SAMLAssertionDeniedPayload) validateTokenEndpointAuthnMethodEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sAMLAssertionDeniedPayloadTypeTokenEndpointAuthnMethodPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SAMLAssertionDeniedPayload) validateTokenEndpointAuthnMethod(formats strfmt.Registry) error {
...
// ContextValidate validate this s a m l assertion denied payload based on the context it is used
func (m *SAMLAssertionDeniedPayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SAMLAssertionDeniedPayload) contextValidateRiskEngineContext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SAMLAssertionDeniedPayload) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SAMLAssertionDeniedPayload) UnmarshalBinary(b []byte) error {
	var res SAMLAssertionDeniedPayload
