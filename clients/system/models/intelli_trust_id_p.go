...
func (m *IntelliTrustIDP) validateJit(formats strfmt.Registry) error {
...
func (m *IntelliTrustIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *IntelliTrustIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntelliTrustIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
