...
type MetaIDP struct {
	...
	// credentials
	Credentials *MetaCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *MetaSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this meta ID p
func (m *MetaIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetaIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateJit(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *MetaIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this meta ID p based on the context it is used
func (m *MetaIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MetaIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetaIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MetaIDP) UnmarshalBinary(b []byte) error {
	var res MetaIDP
