...
func (m *GithubIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *GithubIDP) validateJit(formats strfmt.Registry) error {
...
func (m *GithubIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *GithubIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
func (m *GithubIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GithubIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GithubIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GithubIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
