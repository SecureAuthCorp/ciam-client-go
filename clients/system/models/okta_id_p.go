...
func (m *OktaIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *OktaIDP) validateJit(formats strfmt.Registry) error {
...
func (m *OktaIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *OktaIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
func (m *OktaIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
