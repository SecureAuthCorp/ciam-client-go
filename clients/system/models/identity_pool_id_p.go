...
func (m *IdentityPoolIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *IdentityPoolIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *IdentityPoolIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *IdentityPoolIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
func (m *IdentityPoolIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IdentityPoolIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
