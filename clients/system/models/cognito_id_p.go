...
func (m *CognitoIDP) validateJit(formats strfmt.Registry) error {
...
func (m *CognitoIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *CognitoIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CognitoIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
