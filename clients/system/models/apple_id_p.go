...
// AppleIDP apple ID p
//
// swagger:model AppleIDP
type AppleIDP struct {
	...
	// credentials
	Credentials *AppleCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *AppleSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this apple ID p
func (m *AppleIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AppleIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateJit(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *AppleIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this apple ID p based on the context it is used
func (m *AppleIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AppleIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppleIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AppleIDP) UnmarshalBinary(b []byte) error {
	var res AppleIDP
