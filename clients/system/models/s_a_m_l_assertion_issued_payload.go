...
// SAMLAssertionIssuedPayload s a m l assertion issued payload
//
// swagger:model SAMLAssertionIssuedPayload
type SAMLAssertionIssuedPayload struct {
...
// Validate validates this s a m l assertion issued payload
func (m *SAMLAssertionIssuedPayload) Validate(formats strfmt.Registry) error {
	var res []error
...
var sAMLAssertionIssuedPayloadAuthenticationMechanismsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sAMLAssertionIssuedPayloadAuthenticationMechanismsItemsEnum = append(sAMLAssertionIssuedPayloadAuthenticationMechanismsItemsEnum, v)
	}
}

func (m *SAMLAssertionIssuedPayload) validateAuthenticationMechanismsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sAMLAssertionIssuedPayloadAuthenticationMechanismsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SAMLAssertionIssuedPayload) validateAuthenticationMechanisms(formats strfmt.Registry) error {
...
func (m *SAMLAssertionIssuedPayload) validateRiskEngineContext(formats strfmt.Registry) error {
...
var sAMLAssertionIssuedPayloadTypeTokenEndpointAuthnMethodPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		sAMLAssertionIssuedPayloadTypeTokenEndpointAuthnMethodPropEnum = append(sAMLAssertionIssuedPayloadTypeTokenEndpointAuthnMethodPropEnum, v)
	}
}

const (

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretBasic captures enum value "client_secret_basic"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretBasic string = "client_secret_basic"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretPost captures enum value "client_secret_post"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretPost string = "client_secret_post"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretJwt captures enum value "client_secret_jwt"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodClientSecretJwt string = "client_secret_jwt"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodPrivateKeyJwt captures enum value "private_key_jwt"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodPrivateKeyJwt string = "private_key_jwt"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodSelfSignedTLSClientAuth captures enum value "self_signed_tls_client_auth"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodSelfSignedTLSClientAuth string = "self_signed_tls_client_auth"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodTLSClientAuth captures enum value "tls_client_auth"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodTLSClientAuth string = "tls_client_auth"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodNone captures enum value "none"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodNone string = "none"

	// SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodUnspecified captures enum value "unspecified"
	SAMLAssertionIssuedPayloadTokenEndpointAuthnMethodUnspecified string = "unspecified"
)

// prop value enum
func (m *SAMLAssertionIssuedPayload) validateTokenEndpointAuthnMethodEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, sAMLAssertionIssuedPayloadTypeTokenEndpointAuthnMethodPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *SAMLAssertionIssuedPayload) validateTokenEndpointAuthnMethod(formats strfmt.Registry) error {
...
// ContextValidate validate this s a m l assertion issued payload based on the context it is used
func (m *SAMLAssertionIssuedPayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SAMLAssertionIssuedPayload) contextValidateRiskEngineContext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SAMLAssertionIssuedPayload) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SAMLAssertionIssuedPayload) UnmarshalBinary(b []byte) error {
	var res SAMLAssertionIssuedPayload
