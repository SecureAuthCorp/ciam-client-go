...
// WithXCorrelationID adds the xCorrelationID to the delete client params
func (o *DeleteClientParams) WithXCorrelationID(xCorrelationID *string) *DeleteClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete client params
func (o *DeleteClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete client params
func (o *DeleteClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete client params
func (o *DeleteClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
