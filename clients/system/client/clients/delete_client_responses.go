...
func (o *DeleteClientReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /client/{cid}] deleteClient", response, response.Code())
	}
}
...
func (o *DeleteClientNoContent) Error() string {
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientNoContent", 204)
}
...
func (o *DeleteClientBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientBadRequest %s", 400, payload)
}
...
func (o *DeleteClientUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientUnauthorized %s", 401, payload)
}
...
func (o *DeleteClientForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientForbidden %s", 403, payload)
}
...
func (o *DeleteClientNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientNotFound %s", 404, payload)
}
...
func (o *DeleteClientTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /client/{cid}][%d] deleteClientTooManyRequests %s", 429, payload)
}
