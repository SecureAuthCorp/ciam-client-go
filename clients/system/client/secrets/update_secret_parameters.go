...
// WithXCorrelationID adds the xCorrelationID to the update secret params
func (o *UpdateSecretParams) WithXCorrelationID(xCorrelationID *string) *UpdateSecretParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update secret params
func (o *UpdateSecretParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update secret params
func (o *UpdateSecretParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateSecretParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update secret params
func (o *UpdateSecretParams) SetXIdempotencyKey(xIdempotencyKey *string) {
