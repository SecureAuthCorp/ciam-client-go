...
// WithXCorrelationID adds the xCorrelationID to the delete secret params
func (o *DeleteSecretParams) WithXCorrelationID(xCorrelationID *string) *DeleteSecretParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete secret params
func (o *DeleteSecretParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete secret params
func (o *DeleteSecretParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteSecretParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete secret params
func (o *DeleteSecretParams) SetXIdempotencyKey(xIdempotencyKey *string) {
