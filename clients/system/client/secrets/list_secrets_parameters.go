...
// WithXCorrelationID adds the xCorrelationID to the list secrets params
func (o *ListSecretsParams) WithXCorrelationID(xCorrelationID *string) *ListSecretsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list secrets params
func (o *ListSecretsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list secrets params
func (o *ListSecretsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListSecretsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list secrets params
func (o *ListSecretsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
