...
// WithXCorrelationID adds the xCorrelationID to the get azure ID p client params
func (o *GetAzureIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetAzureIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get azure ID p client params
func (o *GetAzureIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get azure ID p client params
func (o *GetAzureIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAzureIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get azure ID p client params
func (o *GetAzureIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
