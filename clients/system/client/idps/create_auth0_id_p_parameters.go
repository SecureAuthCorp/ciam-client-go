...
// WithXCorrelationID adds the xCorrelationID to the create auth0 ID p params
func (o *CreateAuth0IDPParams) WithXCorrelationID(xCorrelationID *string) *CreateAuth0IDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create auth0 ID p params
func (o *CreateAuth0IDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create auth0 ID p params
func (o *CreateAuth0IDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateAuth0IDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create auth0 ID p params
func (o *CreateAuth0IDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
