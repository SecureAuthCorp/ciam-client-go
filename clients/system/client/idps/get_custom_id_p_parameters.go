...
// WithXCorrelationID adds the xCorrelationID to the get custom ID p params
func (o *GetCustomIDPParams) WithXCorrelationID(xCorrelationID *string) *GetCustomIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get custom ID p params
func (o *GetCustomIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get custom ID p params
func (o *GetCustomIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetCustomIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get custom ID p params
func (o *GetCustomIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
