...
// WithXCorrelationID adds the xCorrelationID to the list ID ps for identity pool params
func (o *ListIDPsForIdentityPoolParams) WithXCorrelationID(xCorrelationID *string) *ListIDPsForIdentityPoolParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list ID ps for identity pool params
func (o *ListIDPsForIdentityPoolParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list ID ps for identity pool params
func (o *ListIDPsForIdentityPoolParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListIDPsForIdentityPoolParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list ID ps for identity pool params
func (o *ListIDPsForIdentityPoolParams) SetXIdempotencyKey(xIdempotencyKey *string) {
