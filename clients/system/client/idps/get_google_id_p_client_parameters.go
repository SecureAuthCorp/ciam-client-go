...
// NewGetGoogleIDPClientParams creates a new GetGoogleIDPClientParams object,
...
func NewGetGoogleIDPClientParams() *GetGoogleIDPClientParams {
	return &GetGoogleIDPClientParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetGoogleIDPClientParamsWithTimeout creates a new GetGoogleIDPClientParams object
...
// NewGetGoogleIDPClientParamsWithContext creates a new GetGoogleIDPClientParams object
...
// NewGetGoogleIDPClientParamsWithHTTPClient creates a new GetGoogleIDPClientParams object
...
func (o *GetGoogleIDPClientParams) WithDefaults() *GetGoogleIDPClientParams {
	o.SetDefaults()
	return o
}
...
func (o *GetGoogleIDPClientParams) WithTimeout(timeout time.Duration) *GetGoogleIDPClientParams {
...
func (o *GetGoogleIDPClientParams) WithContext(ctx context.Context) *GetGoogleIDPClientParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetGoogleIDPClientParams) WithIid(iid string) *GetGoogleIDPClientParams {
	o.SetIid(iid)
	return o
}
...
func (o *GetGoogleIDPClientParams) WithWid(wid string) *GetGoogleIDPClientParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the get google ID p client params
func (o *GetGoogleIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetGoogleIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get google ID p client params
func (o *GetGoogleIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get google ID p client params
func (o *GetGoogleIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGoogleIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get google ID p client params
func (o *GetGoogleIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
	o.XIdempotencyKey = xIdempotencyKey
}

// WriteToRequest writes these params to a swagger request
func (o *GetGoogleIDPClientParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
