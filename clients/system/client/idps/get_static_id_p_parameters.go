...
// WithXCorrelationID adds the xCorrelationID to the get static ID p params
func (o *GetStaticIDPParams) WithXCorrelationID(xCorrelationID *string) *GetStaticIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get static ID p params
func (o *GetStaticIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get static ID p params
func (o *GetStaticIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetStaticIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get static ID p params
func (o *GetStaticIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
