...
// WithXCorrelationID adds the xCorrelationID to the update microsoft ID p params
func (o *UpdateMicrosoftIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateMicrosoftIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update microsoft ID p params
func (o *UpdateMicrosoftIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update microsoft ID p params
func (o *UpdateMicrosoftIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateMicrosoftIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update microsoft ID p params
func (o *UpdateMicrosoftIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
