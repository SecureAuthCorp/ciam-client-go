...
func (o *UpdateGoogleIDPParams) WithWid(wid string) *UpdateGoogleIDPParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the update google ID p params
func (o *UpdateGoogleIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateGoogleIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update google ID p params
func (o *UpdateGoogleIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update google ID p params
func (o *UpdateGoogleIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateGoogleIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update google ID p params
func (o *UpdateGoogleIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
