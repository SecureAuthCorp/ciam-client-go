...
// WithXCorrelationID adds the xCorrelationID to the update s a m l ID p params
func (o *UpdateSAMLIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateSAMLIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update s a m l ID p params
func (o *UpdateSAMLIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update s a m l ID p params
func (o *UpdateSAMLIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateSAMLIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update s a m l ID p params
func (o *UpdateSAMLIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
