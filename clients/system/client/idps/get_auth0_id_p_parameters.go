...
// WithXCorrelationID adds the xCorrelationID to the get auth0 ID p params
func (o *GetAuth0IDPParams) WithXCorrelationID(xCorrelationID *string) *GetAuth0IDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get auth0 ID p params
func (o *GetAuth0IDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get auth0 ID p params
func (o *GetAuth0IDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAuth0IDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get auth0 ID p params
func (o *GetAuth0IDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
