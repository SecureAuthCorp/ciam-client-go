...
// WithXCorrelationID adds the xCorrelationID to the get github embedded ID p params
func (o *GetGithubEmbeddedIDPParams) WithXCorrelationID(xCorrelationID *string) *GetGithubEmbeddedIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get github embedded ID p params
func (o *GetGithubEmbeddedIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get github embedded ID p params
func (o *GetGithubEmbeddedIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGithubEmbeddedIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get github embedded ID p params
func (o *GetGithubEmbeddedIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
