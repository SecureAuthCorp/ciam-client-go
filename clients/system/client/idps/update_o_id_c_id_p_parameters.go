...
// WithXCorrelationID adds the xCorrelationID to the update o ID c ID p params
func (o *UpdateOIDCIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateOIDCIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update o ID c ID p params
func (o *UpdateOIDCIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update o ID c ID p params
func (o *UpdateOIDCIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateOIDCIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update o ID c ID p params
func (o *UpdateOIDCIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
