...
// WithXCorrelationID adds the xCorrelationID to the create azure b2 c ID p params
func (o *CreateAzureB2CIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateAzureB2CIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create azure b2 c ID p params
func (o *CreateAzureB2CIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create azure b2 c ID p params
func (o *CreateAzureB2CIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateAzureB2CIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create azure b2 c ID p params
func (o *CreateAzureB2CIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
