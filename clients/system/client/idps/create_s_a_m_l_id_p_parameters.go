...
func (o *CreateSAMLIDPParams) WithWid(wid string) *CreateSAMLIDPParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the create s a m l ID p params
func (o *CreateSAMLIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateSAMLIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create s a m l ID p params
func (o *CreateSAMLIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create s a m l ID p params
func (o *CreateSAMLIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateSAMLIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create s a m l ID p params
func (o *CreateSAMLIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
