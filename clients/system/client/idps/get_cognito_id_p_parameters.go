...
// WithXCorrelationID adds the xCorrelationID to the get cognito ID p params
func (o *GetCognitoIDPParams) WithXCorrelationID(xCorrelationID *string) *GetCognitoIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get cognito ID p params
func (o *GetCognitoIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get cognito ID p params
func (o *GetCognitoIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetCognitoIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get cognito ID p params
func (o *GetCognitoIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
