...
// WithXCorrelationID adds the xCorrelationID to the update linked in ID p params
func (o *UpdateLinkedInIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateLinkedInIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update linked in ID p params
func (o *UpdateLinkedInIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update linked in ID p params
func (o *UpdateLinkedInIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateLinkedInIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update linked in ID p params
func (o *UpdateLinkedInIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
