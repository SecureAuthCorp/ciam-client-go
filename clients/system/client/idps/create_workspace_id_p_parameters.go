...
// WithXCorrelationID adds the xCorrelationID to the create workspace ID p params
func (o *CreateWorkspaceIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateWorkspaceIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create workspace ID p params
func (o *CreateWorkspaceIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create workspace ID p params
func (o *CreateWorkspaceIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateWorkspaceIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create workspace ID p params
func (o *CreateWorkspaceIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
