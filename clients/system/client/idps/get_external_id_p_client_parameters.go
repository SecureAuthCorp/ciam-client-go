...
// NewGetExternalIDPClientParams creates a new GetExternalIDPClientParams object,
...
func NewGetExternalIDPClientParams() *GetExternalIDPClientParams {
	return &GetExternalIDPClientParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetExternalIDPClientParamsWithTimeout creates a new GetExternalIDPClientParams object
...
// NewGetExternalIDPClientParamsWithContext creates a new GetExternalIDPClientParams object
...
// NewGetExternalIDPClientParamsWithHTTPClient creates a new GetExternalIDPClientParams object
...
func (o *GetExternalIDPClientParams) WithDefaults() *GetExternalIDPClientParams {
	o.SetDefaults()
	return o
}
...
func (o *GetExternalIDPClientParams) SetDefaults() {
	...
	val := GetExternalIDPClientParams{
		Wid: widDefault,
	}
...
func (o *GetExternalIDPClientParams) WithTimeout(timeout time.Duration) *GetExternalIDPClientParams {
...
func (o *GetExternalIDPClientParams) WithContext(ctx context.Context) *GetExternalIDPClientParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetExternalIDPClientParams) WithHTTPClient(client *http.Client) *GetExternalIDPClientParams {
...
func (o *GetExternalIDPClientParams) WithIfMatch(ifMatch *string) *GetExternalIDPClientParams {
...
func (o *GetExternalIDPClientParams) WithIid(iid string) *GetExternalIDPClientParams {
	o.SetIid(iid)
	return o
}
...
func (o *GetExternalIDPClientParams) WithWid(wid string) *GetExternalIDPClientParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the get external ID p client params
func (o *GetExternalIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetExternalIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get external ID p client params
func (o *GetExternalIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get external ID p client params
func (o *GetExternalIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetExternalIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get external ID p client params
func (o *GetExternalIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
	o.XIdempotencyKey = xIdempotencyKey
}

// WriteToRequest writes these params to a swagger request
func (o *GetExternalIDPClientParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
