...
func (o *UpdateIntelliTrustIDPParams) WithIfMatch(ifMatch *string) *UpdateIntelliTrustIDPParams {
...
// WithXCorrelationID adds the xCorrelationID to the update intelli trust ID p params
func (o *UpdateIntelliTrustIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateIntelliTrustIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update intelli trust ID p params
func (o *UpdateIntelliTrustIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update intelli trust ID p params
func (o *UpdateIntelliTrustIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateIntelliTrustIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update intelli trust ID p params
func (o *UpdateIntelliTrustIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
