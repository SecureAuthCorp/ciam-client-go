...
// WithXCorrelationID adds the xCorrelationID to the create organization ID p params
func (o *CreateOrganizationIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateOrganizationIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create organization ID p params
func (o *CreateOrganizationIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create organization ID p params
func (o *CreateOrganizationIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateOrganizationIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create organization ID p params
func (o *CreateOrganizationIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
