...
// WithXCorrelationID adds the xCorrelationID to the update github ID p params
func (o *UpdateGithubIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateGithubIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update github ID p params
func (o *UpdateGithubIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update github ID p params
func (o *UpdateGithubIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateGithubIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update github ID p params
func (o *UpdateGithubIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
