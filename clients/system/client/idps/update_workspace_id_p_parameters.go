...
// WithXCorrelationID adds the xCorrelationID to the update workspace ID p params
func (o *UpdateWorkspaceIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateWorkspaceIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update workspace ID p params
func (o *UpdateWorkspaceIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update workspace ID p params
func (o *UpdateWorkspaceIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateWorkspaceIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update workspace ID p params
func (o *UpdateWorkspaceIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
