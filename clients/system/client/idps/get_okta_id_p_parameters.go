...
// WithXCorrelationID adds the xCorrelationID to the get okta ID p params
func (o *GetOktaIDPParams) WithXCorrelationID(xCorrelationID *string) *GetOktaIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get okta ID p params
func (o *GetOktaIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get okta ID p params
func (o *GetOktaIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOktaIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get okta ID p params
func (o *GetOktaIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
