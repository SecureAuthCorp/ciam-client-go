...
// WithXCorrelationID adds the xCorrelationID to the create github ID p params
func (o *CreateGithubIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateGithubIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create github ID p params
func (o *CreateGithubIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create github ID p params
func (o *CreateGithubIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateGithubIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create github ID p params
func (o *CreateGithubIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
