...
// WithXCorrelationID adds the xCorrelationID to the get workspace ID p params
func (o *GetWorkspaceIDPParams) WithXCorrelationID(xCorrelationID *string) *GetWorkspaceIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get workspace ID p params
func (o *GetWorkspaceIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get workspace ID p params
func (o *GetWorkspaceIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetWorkspaceIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get workspace ID p params
func (o *GetWorkspaceIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
