...
// WithXCorrelationID adds the xCorrelationID to the update external ID p params
func (o *UpdateExternalIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateExternalIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update external ID p params
func (o *UpdateExternalIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update external ID p params
func (o *UpdateExternalIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateExternalIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update external ID p params
func (o *UpdateExternalIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
