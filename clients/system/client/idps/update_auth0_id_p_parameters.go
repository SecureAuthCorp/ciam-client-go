...
// WithXCorrelationID adds the xCorrelationID to the update auth0 ID p params
func (o *UpdateAuth0IDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateAuth0IDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update auth0 ID p params
func (o *UpdateAuth0IDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update auth0 ID p params
func (o *UpdateAuth0IDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAuth0IDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update auth0 ID p params
func (o *UpdateAuth0IDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
