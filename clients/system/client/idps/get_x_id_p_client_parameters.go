...
// WithXCorrelationID adds the xCorrelationID to the get x ID p client params
func (o *GetXIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetXIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get x ID p client params
func (o *GetXIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get x ID p client params
func (o *GetXIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetXIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get x ID p client params
func (o *GetXIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
