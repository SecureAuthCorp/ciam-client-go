...
// WithXCorrelationID adds the xCorrelationID to the get organization ID p params
func (o *GetOrganizationIDPParams) WithXCorrelationID(xCorrelationID *string) *GetOrganizationIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get organization ID p params
func (o *GetOrganizationIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get organization ID p params
func (o *GetOrganizationIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOrganizationIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get organization ID p params
func (o *GetOrganizationIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
