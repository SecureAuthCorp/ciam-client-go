...
// WithXCorrelationID adds the xCorrelationID to the update azure b2 c ID p params
func (o *UpdateAzureB2CIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateAzureB2CIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update azure b2 c ID p params
func (o *UpdateAzureB2CIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update azure b2 c ID p params
func (o *UpdateAzureB2CIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAzureB2CIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update azure b2 c ID p params
func (o *UpdateAzureB2CIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
