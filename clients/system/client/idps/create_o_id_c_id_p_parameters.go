...
// WithXCorrelationID adds the xCorrelationID to the create o ID c ID p params
func (o *CreateOIDCIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateOIDCIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create o ID c ID p params
func (o *CreateOIDCIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create o ID c ID p params
func (o *CreateOIDCIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateOIDCIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create o ID c ID p params
func (o *CreateOIDCIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
