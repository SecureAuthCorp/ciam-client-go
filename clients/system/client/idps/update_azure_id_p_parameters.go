...
// WithXCorrelationID adds the xCorrelationID to the update azure ID p params
func (o *UpdateAzureIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateAzureIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update azure ID p params
func (o *UpdateAzureIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update azure ID p params
func (o *UpdateAzureIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAzureIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update azure ID p params
func (o *UpdateAzureIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
