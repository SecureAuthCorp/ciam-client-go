...
// NewGetCognitoIDPClientParams creates a new GetCognitoIDPClientParams object,
...
func NewGetCognitoIDPClientParams() *GetCognitoIDPClientParams {
	return &GetCognitoIDPClientParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetCognitoIDPClientParamsWithTimeout creates a new GetCognitoIDPClientParams object
...
// NewGetCognitoIDPClientParamsWithContext creates a new GetCognitoIDPClientParams object
...
// NewGetCognitoIDPClientParamsWithHTTPClient creates a new GetCognitoIDPClientParams object
...
func (o *GetCognitoIDPClientParams) WithDefaults() *GetCognitoIDPClientParams {
	o.SetDefaults()
	return o
}
...
func (o *GetCognitoIDPClientParams) WithTimeout(timeout time.Duration) *GetCognitoIDPClientParams {
...
func (o *GetCognitoIDPClientParams) WithContext(ctx context.Context) *GetCognitoIDPClientParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetCognitoIDPClientParams) WithIfMatch(ifMatch *string) *GetCognitoIDPClientParams {
...
func (o *GetCognitoIDPClientParams) WithIid(iid string) *GetCognitoIDPClientParams {
	o.SetIid(iid)
	return o
}
...
func (o *GetCognitoIDPClientParams) WithWid(wid string) *GetCognitoIDPClientParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the get cognito ID p client params
func (o *GetCognitoIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetCognitoIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get cognito ID p client params
func (o *GetCognitoIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get cognito ID p client params
func (o *GetCognitoIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetCognitoIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get cognito ID p client params
func (o *GetCognitoIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
	o.XIdempotencyKey = xIdempotencyKey
}

// WriteToRequest writes these params to a swagger request
func (o *GetCognitoIDPClientParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
