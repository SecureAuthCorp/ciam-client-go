...
// WithXCorrelationID adds the xCorrelationID to the get linked in ID p client params
func (o *GetLinkedInIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetLinkedInIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get linked in ID p client params
func (o *GetLinkedInIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get linked in ID p client params
func (o *GetLinkedInIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetLinkedInIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get linked in ID p client params
func (o *GetLinkedInIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
