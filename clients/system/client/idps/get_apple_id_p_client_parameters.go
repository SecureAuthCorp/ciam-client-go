...
// WithXCorrelationID adds the xCorrelationID to the get apple ID p client params
func (o *GetAppleIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetAppleIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get apple ID p client params
func (o *GetAppleIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get apple ID p client params
func (o *GetAppleIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAppleIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get apple ID p client params
func (o *GetAppleIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
