...
// NewGetOktaIDPClientParams creates a new GetOktaIDPClientParams object,
...
func NewGetOktaIDPClientParams() *GetOktaIDPClientParams {
	return &GetOktaIDPClientParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetOktaIDPClientParamsWithTimeout creates a new GetOktaIDPClientParams object
...
// NewGetOktaIDPClientParamsWithContext creates a new GetOktaIDPClientParams object
...
// NewGetOktaIDPClientParamsWithHTTPClient creates a new GetOktaIDPClientParams object
...
func (o *GetOktaIDPClientParams) WithDefaults() *GetOktaIDPClientParams {
	o.SetDefaults()
	return o
}
...
func (o *GetOktaIDPClientParams) WithTimeout(timeout time.Duration) *GetOktaIDPClientParams {
...
func (o *GetOktaIDPClientParams) WithContext(ctx context.Context) *GetOktaIDPClientParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetOktaIDPClientParams) WithIid(iid string) *GetOktaIDPClientParams {
	o.SetIid(iid)
	return o
}
...
func (o *GetOktaIDPClientParams) WithWid(wid string) *GetOktaIDPClientParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the get okta ID p client params
func (o *GetOktaIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetOktaIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get okta ID p client params
func (o *GetOktaIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get okta ID p client params
func (o *GetOktaIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOktaIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get okta ID p client params
func (o *GetOktaIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
	o.XIdempotencyKey = xIdempotencyKey
}

// WriteToRequest writes these params to a swagger request
func (o *GetOktaIDPClientParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
