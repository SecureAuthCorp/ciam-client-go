...
// WithXCorrelationID adds the xCorrelationID to the get microsoft ID p params
func (o *GetMicrosoftIDPParams) WithXCorrelationID(xCorrelationID *string) *GetMicrosoftIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get microsoft ID p params
func (o *GetMicrosoftIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get microsoft ID p params
func (o *GetMicrosoftIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetMicrosoftIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get microsoft ID p params
func (o *GetMicrosoftIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
