...
// WithXCorrelationID adds the xCorrelationID to the update identity pool ID p params
func (o *UpdateIdentityPoolIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateIdentityPoolIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update identity pool ID p params
func (o *UpdateIdentityPoolIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update identity pool ID p params
func (o *UpdateIdentityPoolIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateIdentityPoolIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update identity pool ID p params
func (o *UpdateIdentityPoolIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
