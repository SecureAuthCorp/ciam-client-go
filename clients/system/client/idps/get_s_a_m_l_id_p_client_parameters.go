...
// WithXCorrelationID adds the xCorrelationID to the get s a m l ID p client params
func (o *GetSAMLIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetSAMLIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get s a m l ID p client params
func (o *GetSAMLIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get s a m l ID p client params
func (o *GetSAMLIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetSAMLIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get s a m l ID p client params
func (o *GetSAMLIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
