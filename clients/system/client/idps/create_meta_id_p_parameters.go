...
// WithXCorrelationID adds the xCorrelationID to the create meta ID p params
func (o *CreateMetaIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateMetaIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create meta ID p params
func (o *CreateMetaIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create meta ID p params
func (o *CreateMetaIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateMetaIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create meta ID p params
func (o *CreateMetaIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
