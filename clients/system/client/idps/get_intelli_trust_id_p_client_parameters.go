...
// WithXCorrelationID adds the xCorrelationID to the get intelli trust ID p client params
func (o *GetIntelliTrustIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetIntelliTrustIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get intelli trust ID p client params
func (o *GetIntelliTrustIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get intelli trust ID p client params
func (o *GetIntelliTrustIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetIntelliTrustIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get intelli trust ID p client params
func (o *GetIntelliTrustIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
