...
// WithXCorrelationID adds the xCorrelationID to the get azure ID p params
func (o *GetAzureIDPParams) WithXCorrelationID(xCorrelationID *string) *GetAzureIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get azure ID p params
func (o *GetAzureIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get azure ID p params
func (o *GetAzureIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAzureIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get azure ID p params
func (o *GetAzureIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
