...
// WithXCorrelationID adds the xCorrelationID to the get azure b2 c ID p params
func (o *GetAzureB2CIDPParams) WithXCorrelationID(xCorrelationID *string) *GetAzureB2CIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get azure b2 c ID p params
func (o *GetAzureB2CIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get azure b2 c ID p params
func (o *GetAzureB2CIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAzureB2CIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get azure b2 c ID p params
func (o *GetAzureB2CIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
