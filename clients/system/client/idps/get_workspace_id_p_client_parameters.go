...
// WithXCorrelationID adds the xCorrelationID to the get workspace ID p client params
func (o *GetWorkspaceIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetWorkspaceIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get workspace ID p client params
func (o *GetWorkspaceIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get workspace ID p client params
func (o *GetWorkspaceIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetWorkspaceIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get workspace ID p client params
func (o *GetWorkspaceIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
