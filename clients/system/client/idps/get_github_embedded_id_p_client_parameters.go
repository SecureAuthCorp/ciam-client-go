...
// WithXCorrelationID adds the xCorrelationID to the get github embedded ID p client params
func (o *GetGithubEmbeddedIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetGithubEmbeddedIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get github embedded ID p client params
func (o *GetGithubEmbeddedIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get github embedded ID p client params
func (o *GetGithubEmbeddedIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGithubEmbeddedIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get github embedded ID p client params
func (o *GetGithubEmbeddedIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
