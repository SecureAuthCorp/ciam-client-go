...
// WithXCorrelationID adds the xCorrelationID to the update cognito ID p params
func (o *UpdateCognitoIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateCognitoIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update cognito ID p params
func (o *UpdateCognitoIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update cognito ID p params
func (o *UpdateCognitoIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateCognitoIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update cognito ID p params
func (o *UpdateCognitoIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
