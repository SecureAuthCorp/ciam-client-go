...
// WithXCorrelationID adds the xCorrelationID to the delete ID p params
func (o *DeleteIDPParams) WithXCorrelationID(xCorrelationID *string) *DeleteIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete ID p params
func (o *DeleteIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete ID p params
func (o *DeleteIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete ID p params
func (o *DeleteIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
