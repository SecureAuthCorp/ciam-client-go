...
// WithXCorrelationID adds the xCorrelationID to the update google embedded ID p params
func (o *UpdateGoogleEmbeddedIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateGoogleEmbeddedIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update google embedded ID p params
func (o *UpdateGoogleEmbeddedIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update google embedded ID p params
func (o *UpdateGoogleEmbeddedIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateGoogleEmbeddedIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update google embedded ID p params
func (o *UpdateGoogleEmbeddedIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
