...
// WithXCorrelationID adds the xCorrelationID to the get azure b2 c ID p client params
func (o *GetAzureB2CIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetAzureB2CIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get azure b2 c ID p client params
func (o *GetAzureB2CIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get azure b2 c ID p client params
func (o *GetAzureB2CIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAzureB2CIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get azure b2 c ID p client params
func (o *GetAzureB2CIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
