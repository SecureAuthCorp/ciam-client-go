...
// WithXCorrelationID adds the xCorrelationID to the create intelli trust ID p params
func (o *CreateIntelliTrustIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateIntelliTrustIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create intelli trust ID p params
func (o *CreateIntelliTrustIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create intelli trust ID p params
func (o *CreateIntelliTrustIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateIntelliTrustIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create intelli trust ID p params
func (o *CreateIntelliTrustIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
