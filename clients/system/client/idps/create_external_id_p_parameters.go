...
// WithXCorrelationID adds the xCorrelationID to the create external ID p params
func (o *CreateExternalIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateExternalIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create external ID p params
func (o *CreateExternalIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create external ID p params
func (o *CreateExternalIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateExternalIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create external ID p params
func (o *CreateExternalIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
