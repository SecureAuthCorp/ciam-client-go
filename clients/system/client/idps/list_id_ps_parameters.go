...
// WithXCorrelationID adds the xCorrelationID to the list ID ps params
func (o *ListIDPsParams) WithXCorrelationID(xCorrelationID *string) *ListIDPsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list ID ps params
func (o *ListIDPsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list ID ps params
func (o *ListIDPsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListIDPsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list ID ps params
func (o *ListIDPsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
