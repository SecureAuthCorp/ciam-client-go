...
// WithXCorrelationID adds the xCorrelationID to the create custom ID p params
func (o *CreateCustomIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateCustomIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create custom ID p params
func (o *CreateCustomIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create custom ID p params
func (o *CreateCustomIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateCustomIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create custom ID p params
func (o *CreateCustomIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
