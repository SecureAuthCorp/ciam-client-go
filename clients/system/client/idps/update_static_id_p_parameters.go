...
// WithXCorrelationID adds the xCorrelationID to the update static ID p params
func (o *UpdateStaticIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateStaticIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update static ID p params
func (o *UpdateStaticIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update static ID p params
func (o *UpdateStaticIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateStaticIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update static ID p params
func (o *UpdateStaticIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
