...
// WithXCorrelationID adds the xCorrelationID to the get google ID p params
func (o *GetGoogleIDPParams) WithXCorrelationID(xCorrelationID *string) *GetGoogleIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get google ID p params
func (o *GetGoogleIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get google ID p params
func (o *GetGoogleIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGoogleIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get google ID p params
func (o *GetGoogleIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
