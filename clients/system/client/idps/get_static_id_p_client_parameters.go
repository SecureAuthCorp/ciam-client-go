...
// WithXCorrelationID adds the xCorrelationID to the get static ID p client params
func (o *GetStaticIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetStaticIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get static ID p client params
func (o *GetStaticIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get static ID p client params
func (o *GetStaticIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetStaticIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get static ID p client params
func (o *GetStaticIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
