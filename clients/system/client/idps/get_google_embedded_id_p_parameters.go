...
// WithXCorrelationID adds the xCorrelationID to the get google embedded ID p params
func (o *GetGoogleEmbeddedIDPParams) WithXCorrelationID(xCorrelationID *string) *GetGoogleEmbeddedIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get google embedded ID p params
func (o *GetGoogleEmbeddedIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get google embedded ID p params
func (o *GetGoogleEmbeddedIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGoogleEmbeddedIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get google embedded ID p params
func (o *GetGoogleEmbeddedIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
