...
// WithXCorrelationID adds the xCorrelationID to the create azure ID p params
func (o *CreateAzureIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateAzureIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create azure ID p params
func (o *CreateAzureIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create azure ID p params
func (o *CreateAzureIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateAzureIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create azure ID p params
func (o *CreateAzureIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
