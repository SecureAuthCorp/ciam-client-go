...
// NewGetAuth0IDPClientParams creates a new GetAuth0IDPClientParams object,
...
func NewGetAuth0IDPClientParams() *GetAuth0IDPClientParams {
	return &GetAuth0IDPClientParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetAuth0IDPClientParamsWithTimeout creates a new GetAuth0IDPClientParams object
...
// NewGetAuth0IDPClientParamsWithContext creates a new GetAuth0IDPClientParams object
...
// NewGetAuth0IDPClientParamsWithHTTPClient creates a new GetAuth0IDPClientParams object
...
func (o *GetAuth0IDPClientParams) WithDefaults() *GetAuth0IDPClientParams {
	o.SetDefaults()
	return o
}
...
func (o *GetAuth0IDPClientParams) WithTimeout(timeout time.Duration) *GetAuth0IDPClientParams {
...
func (o *GetAuth0IDPClientParams) WithContext(ctx context.Context) *GetAuth0IDPClientParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetAuth0IDPClientParams) WithIid(iid string) *GetAuth0IDPClientParams {
	o.SetIid(iid)
	return o
}
...
func (o *GetAuth0IDPClientParams) WithWid(wid string) *GetAuth0IDPClientParams {
	o.SetWid(wid)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the get auth0 ID p client params
func (o *GetAuth0IDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetAuth0IDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get auth0 ID p client params
func (o *GetAuth0IDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get auth0 ID p client params
func (o *GetAuth0IDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAuth0IDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get auth0 ID p client params
func (o *GetAuth0IDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
	o.XIdempotencyKey = xIdempotencyKey
}

// WriteToRequest writes these params to a swagger request
func (o *GetAuth0IDPClientParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
