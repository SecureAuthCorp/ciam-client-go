...
// WithXCorrelationID adds the xCorrelationID to the get google embedded ID p client params
func (o *GetGoogleEmbeddedIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetGoogleEmbeddedIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get google embedded ID p client params
func (o *GetGoogleEmbeddedIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get google embedded ID p client params
func (o *GetGoogleEmbeddedIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGoogleEmbeddedIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get google embedded ID p client params
func (o *GetGoogleEmbeddedIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
