...
// WithXCorrelationID adds the xCorrelationID to the create identity pool ID p params
func (o *CreateIdentityPoolIDPParams) WithXCorrelationID(xCorrelationID *string) *CreateIdentityPoolIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create identity pool ID p params
func (o *CreateIdentityPoolIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create identity pool ID p params
func (o *CreateIdentityPoolIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateIdentityPoolIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create identity pool ID p params
func (o *CreateIdentityPoolIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
