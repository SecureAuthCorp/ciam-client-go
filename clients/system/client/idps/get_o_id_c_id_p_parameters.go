...
// WithXCorrelationID adds the xCorrelationID to the get o ID c ID p params
func (o *GetOIDCIDPParams) WithXCorrelationID(xCorrelationID *string) *GetOIDCIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get o ID c ID p params
func (o *GetOIDCIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get o ID c ID p params
func (o *GetOIDCIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOIDCIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get o ID c ID p params
func (o *GetOIDCIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
