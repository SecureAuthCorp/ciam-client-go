...
// WithXCorrelationID adds the xCorrelationID to the get github ID p params
func (o *GetGithubIDPParams) WithXCorrelationID(xCorrelationID *string) *GetGithubIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get github ID p params
func (o *GetGithubIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get github ID p params
func (o *GetGithubIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGithubIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get github ID p params
func (o *GetGithubIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
