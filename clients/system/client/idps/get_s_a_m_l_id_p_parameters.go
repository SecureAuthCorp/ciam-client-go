...
// WithXCorrelationID adds the xCorrelationID to the get s a m l ID p params
func (o *GetSAMLIDPParams) WithXCorrelationID(xCorrelationID *string) *GetSAMLIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get s a m l ID p params
func (o *GetSAMLIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get s a m l ID p params
func (o *GetSAMLIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetSAMLIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get s a m l ID p params
func (o *GetSAMLIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
