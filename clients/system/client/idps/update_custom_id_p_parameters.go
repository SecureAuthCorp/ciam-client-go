...
// WithXCorrelationID adds the xCorrelationID to the update custom ID p params
func (o *UpdateCustomIDPParams) WithXCorrelationID(xCorrelationID *string) *UpdateCustomIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update custom ID p params
func (o *UpdateCustomIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update custom ID p params
func (o *UpdateCustomIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateCustomIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update custom ID p params
func (o *UpdateCustomIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
