...
// WithXCorrelationID adds the xCorrelationID to the get github ID p client params
func (o *GetGithubIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetGithubIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get github ID p client params
func (o *GetGithubIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get github ID p client params
func (o *GetGithubIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGithubIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get github ID p client params
func (o *GetGithubIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
