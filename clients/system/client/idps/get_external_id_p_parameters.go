...
// WithXCorrelationID adds the xCorrelationID to the get external ID p params
func (o *GetExternalIDPParams) WithXCorrelationID(xCorrelationID *string) *GetExternalIDPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get external ID p params
func (o *GetExternalIDPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get external ID p params
func (o *GetExternalIDPParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetExternalIDPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get external ID p params
func (o *GetExternalIDPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
