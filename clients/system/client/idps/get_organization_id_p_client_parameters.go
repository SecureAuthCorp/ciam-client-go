...
// WithXCorrelationID adds the xCorrelationID to the get organization ID p client params
func (o *GetOrganizationIDPClientParams) WithXCorrelationID(xCorrelationID *string) *GetOrganizationIDPClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get organization ID p client params
func (o *GetOrganizationIDPClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get organization ID p client params
func (o *GetOrganizationIDPClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOrganizationIDPClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get organization ID p client params
func (o *GetOrganizationIDPClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
