...
// WithXCorrelationID adds the xCorrelationID to the update organization params
func (o *UpdateOrganizationParams) WithXCorrelationID(xCorrelationID *string) *UpdateOrganizationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update organization params
func (o *UpdateOrganizationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update organization params
func (o *UpdateOrganizationParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateOrganizationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update organization params
func (o *UpdateOrganizationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
