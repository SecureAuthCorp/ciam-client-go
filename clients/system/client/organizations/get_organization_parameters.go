...
// WithXCorrelationID adds the xCorrelationID to the get organization params
func (o *GetOrganizationParams) WithXCorrelationID(xCorrelationID *string) *GetOrganizationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get organization params
func (o *GetOrganizationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get organization params
func (o *GetOrganizationParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOrganizationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get organization params
func (o *GetOrganizationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
