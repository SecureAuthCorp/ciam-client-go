...
// WithXCorrelationID adds the xCorrelationID to the delete authorization server params
func (o *DeleteAuthorizationServerParams) WithXCorrelationID(xCorrelationID *string) *DeleteAuthorizationServerParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete authorization server params
func (o *DeleteAuthorizationServerParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete authorization server params
func (o *DeleteAuthorizationServerParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteAuthorizationServerParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete authorization server params
func (o *DeleteAuthorizationServerParams) SetXIdempotencyKey(xIdempotencyKey *string) {
