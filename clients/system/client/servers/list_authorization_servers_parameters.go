...
// WithXCorrelationID adds the xCorrelationID to the list authorization servers params
func (o *ListAuthorizationServersParams) WithXCorrelationID(xCorrelationID *string) *ListAuthorizationServersParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list authorization servers params
func (o *ListAuthorizationServersParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list authorization servers params
func (o *ListAuthorizationServersParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListAuthorizationServersParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list authorization servers params
func (o *ListAuthorizationServersParams) SetXIdempotencyKey(xIdempotencyKey *string) {
