...
// WithXCorrelationID adds the xCorrelationID to the reset password confirm params
func (o *ResetPasswordConfirmParams) WithXCorrelationID(xCorrelationID *string) *ResetPasswordConfirmParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the reset password confirm params
func (o *ResetPasswordConfirmParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the reset password confirm params
func (o *ResetPasswordConfirmParams) WithXIdempotencyKey(xIdempotencyKey *string) *ResetPasswordConfirmParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the reset password confirm params
func (o *ResetPasswordConfirmParams) SetXIdempotencyKey(xIdempotencyKey *string) {
