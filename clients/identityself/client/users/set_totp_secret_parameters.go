...
// WithXCorrelationID adds the xCorrelationID to the set totp secret params
func (o *SetTotpSecretParams) WithXCorrelationID(xCorrelationID *string) *SetTotpSecretParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set totp secret params
func (o *SetTotpSecretParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set totp secret params
func (o *SetTotpSecretParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetTotpSecretParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set totp secret params
func (o *SetTotpSecretParams) SetXIdempotencyKey(xIdempotencyKey *string) {
