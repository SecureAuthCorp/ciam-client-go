...
// WithXCorrelationID adds the xCorrelationID to the get user profile params
func (o *GetUserProfileParams) WithXCorrelationID(xCorrelationID *string) *GetUserProfileParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get user profile params
func (o *GetUserProfileParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get user profile params
func (o *GetUserProfileParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetUserProfileParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get user profile params
func (o *GetUserProfileParams) SetXIdempotencyKey(xIdempotencyKey *string) {
