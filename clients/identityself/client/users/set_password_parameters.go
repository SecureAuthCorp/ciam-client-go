...
// WithXCorrelationID adds the xCorrelationID to the set password params
func (o *SetPasswordParams) WithXCorrelationID(xCorrelationID *string) *SetPasswordParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set password params
func (o *SetPasswordParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set password params
func (o *SetPasswordParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetPasswordParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set password params
func (o *SetPasswordParams) SetXIdempotencyKey(xIdempotencyKey *string) {
