...
// WithXCorrelationID adds the xCorrelationID to the update user profile v2 params
func (o *UpdateUserProfileV2Params) WithXCorrelationID(xCorrelationID *string) *UpdateUserProfileV2Params {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update user profile v2 params
func (o *UpdateUserProfileV2Params) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update user profile v2 params
func (o *UpdateUserProfileV2Params) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateUserProfileV2Params {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update user profile v2 params
func (o *UpdateUserProfileV2Params) SetXIdempotencyKey(xIdempotencyKey *string) {
