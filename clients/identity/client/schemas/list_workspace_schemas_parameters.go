...
// WithXCorrelationID adds the xCorrelationID to the list workspace schemas params
func (o *ListWorkspaceSchemasParams) WithXCorrelationID(xCorrelationID *string) *ListWorkspaceSchemasParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list workspace schemas params
func (o *ListWorkspaceSchemasParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list workspace schemas params
func (o *ListWorkspaceSchemasParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListWorkspaceSchemasParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list workspace schemas params
func (o *ListWorkspaceSchemasParams) SetXIdempotencyKey(xIdempotencyKey *string) {
