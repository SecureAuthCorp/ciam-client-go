...
// WithXCorrelationID adds the xCorrelationID to the delete schema params
func (o *DeleteSchemaParams) WithXCorrelationID(xCorrelationID *string) *DeleteSchemaParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete schema params
func (o *DeleteSchemaParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete schema params
func (o *DeleteSchemaParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteSchemaParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete schema params
func (o *DeleteSchemaParams) SetXIdempotencyKey(xIdempotencyKey *string) {
