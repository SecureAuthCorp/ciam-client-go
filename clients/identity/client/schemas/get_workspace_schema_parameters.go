...
// WithXCorrelationID adds the xCorrelationID to the get workspace schema params
func (o *GetWorkspaceSchemaParams) WithXCorrelationID(xCorrelationID *string) *GetWorkspaceSchemaParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get workspace schema params
func (o *GetWorkspaceSchemaParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get workspace schema params
func (o *GetWorkspaceSchemaParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetWorkspaceSchemaParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get workspace schema params
func (o *GetWorkspaceSchemaParams) SetXIdempotencyKey(xIdempotencyKey *string) {
