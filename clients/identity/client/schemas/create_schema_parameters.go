...
// WithXCorrelationID adds the xCorrelationID to the create schema params
func (o *CreateSchemaParams) WithXCorrelationID(xCorrelationID *string) *CreateSchemaParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create schema params
func (o *CreateSchemaParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create schema params
func (o *CreateSchemaParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateSchemaParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create schema params
func (o *CreateSchemaParams) SetXIdempotencyKey(xIdempotencyKey *string) {
