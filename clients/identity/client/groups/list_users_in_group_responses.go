...
func (o *ListUsersInGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /admin/pools/{ipID}/groups/{groupID}/users] listUsersInGroup", response, response.Code())
	}
}
...
func (o *ListUsersInGroupOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupOK %s", 200, payload)
}
...
func (o *ListUsersInGroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupBadRequest %s", 400, payload)
}
...
func (o *ListUsersInGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupUnauthorized %s", 401, payload)
}
...
func (o *ListUsersInGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupForbidden %s", 403, payload)
}
...
func (o *ListUsersInGroupNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupNotFound %s", 404, payload)
}
...
func (o *ListUsersInGroupUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupUnprocessableEntity %s", 422, payload)
}
...
func (o *ListUsersInGroupTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupTooManyRequests %s", 429, payload)
}
