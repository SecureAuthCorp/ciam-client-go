...
// WithXCorrelationID adds the xCorrelationID to the create user params
func (o *CreateUserParams) WithXCorrelationID(xCorrelationID *string) *CreateUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create user params
func (o *CreateUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create user params
func (o *CreateUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create user params
func (o *CreateUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
