...
// WithXCorrelationID adds the xCorrelationID to the delete user identifier params
func (o *DeleteUserIdentifierParams) WithXCorrelationID(xCorrelationID *string) *DeleteUserIdentifierParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete user identifier params
func (o *DeleteUserIdentifierParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete user identifier params
func (o *DeleteUserIdentifierParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteUserIdentifierParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete user identifier params
func (o *DeleteUserIdentifierParams) SetXIdempotencyKey(xIdempotencyKey *string) {
