...
// WithXCorrelationID adds the xCorrelationID to the send activation message params
func (o *SendActivationMessageParams) WithXCorrelationID(xCorrelationID *string) *SendActivationMessageParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the send activation message params
func (o *SendActivationMessageParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the send activation message params
func (o *SendActivationMessageParams) WithXIdempotencyKey(xIdempotencyKey *string) *SendActivationMessageParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the send activation message params
func (o *SendActivationMessageParams) SetXIdempotencyKey(xIdempotencyKey *string) {
