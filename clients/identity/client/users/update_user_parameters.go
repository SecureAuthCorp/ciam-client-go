...
// WithXCorrelationID adds the xCorrelationID to the update user params
func (o *UpdateUserParams) WithXCorrelationID(xCorrelationID *string) *UpdateUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update user params
func (o *UpdateUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update user params
func (o *UpdateUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update user params
func (o *UpdateUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
