...
// WithXCorrelationID adds the xCorrelationID to the add user identifier params
func (o *AddUserIdentifierParams) WithXCorrelationID(xCorrelationID *string) *AddUserIdentifierParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the add user identifier params
func (o *AddUserIdentifierParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the add user identifier params
func (o *AddUserIdentifierParams) WithXIdempotencyKey(xIdempotencyKey *string) *AddUserIdentifierParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the add user identifier params
func (o *AddUserIdentifierParams) SetXIdempotencyKey(xIdempotencyKey *string) {
