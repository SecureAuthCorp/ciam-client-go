...
// Code gets the status code for the patch user conflict response
func (o *PatchUserConflict) Code() int {
	return 409
}

func (o *PatchUserConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /admin/pools/{ipID}/users/{userID}][%d] patchUserConflict %s", 409, payload)
}
...
func (o *PatchUserConflict) GetPayload() *models.Error {
	return o.Payload
}
