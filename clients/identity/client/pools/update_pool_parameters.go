...
// WithXCorrelationID adds the xCorrelationID to the update pool params
func (o *UpdatePoolParams) WithXCorrelationID(xCorrelationID *string) *UpdatePoolParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update pool params
func (o *UpdatePoolParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update pool params
func (o *UpdatePoolParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdatePoolParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update pool params
func (o *UpdatePoolParams) SetXIdempotencyKey(xIdempotencyKey *string) {
