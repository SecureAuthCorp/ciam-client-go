...
// WithXCorrelationID adds the xCorrelationID to the list workspace pools params
func (o *ListWorkspacePoolsParams) WithXCorrelationID(xCorrelationID *string) *ListWorkspacePoolsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list workspace pools params
func (o *ListWorkspacePoolsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list workspace pools params
func (o *ListWorkspacePoolsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListWorkspacePoolsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list workspace pools params
func (o *ListWorkspacePoolsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
