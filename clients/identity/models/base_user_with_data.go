...
func (m *BaseUserWithData) validatePreferences(formats strfmt.Registry) error {
...
var baseUserWithDataTypeUserTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		baseUserWithDataTypeUserTypePropEnum = append(baseUserWithDataTypeUserTypePropEnum, v)
	}
}

const (

	// BaseUserWithDataUserTypeJit captures enum value "jit"
	BaseUserWithDataUserTypeJit string = "jit"

	// BaseUserWithDataUserTypeStandard captures enum value "standard"
	BaseUserWithDataUserTypeStandard string = "standard"

	// BaseUserWithDataUserTypeScim captures enum value "scim"
	BaseUserWithDataUserTypeScim string = "scim"
)

// prop value enum
func (m *BaseUserWithData) validateUserTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, baseUserWithDataTypeUserTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *BaseUserWithData) validateUserType(formats strfmt.Registry) error {
...
func (m *BaseUserWithData) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
