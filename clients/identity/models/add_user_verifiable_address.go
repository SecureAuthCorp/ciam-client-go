...
func (m *AddUserVerifiableAddress) validateMessageRedaction(formats strfmt.Registry) error {
...
// ContextValidate validate this add user verifiable address based on the context it is used
...
func (m *AddUserVerifiableAddress) contextValidateMessageRedaction(ctx context.Context, formats strfmt.Registry) error {
