...
func (m *BaseNewUserPayload) validatePreferences(formats strfmt.Registry) error {
...
func (m *BaseNewUserPayload) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
