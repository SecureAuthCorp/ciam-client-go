...
func (o *AdminSetTenantLicenseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /admin/tenants/{tenantID}/license] adminSetTenantLicense", response, response.Code())
	}
}
...
func (o *AdminSetTenantLicenseNoContent) Error() string {
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseNoContent", 204)
}
...
func (o *AdminSetTenantLicenseBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseBadRequest %s", 400, payload)
}
...
func (o *AdminSetTenantLicenseUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseUnauthorized %s", 401, payload)
}
...
func (o *AdminSetTenantLicenseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseForbidden %s", 403, payload)
}
...
func (o *AdminSetTenantLicenseNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseNotFound %s", 404, payload)
}
...
func (o *AdminSetTenantLicenseUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseUnprocessableEntity %s", 422, payload)
}
...
func (o *AdminSetTenantLicenseTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/tenants/{tenantID}/license][%d] adminSetTenantLicenseTooManyRequests %s", 429, payload)
}
