...
func (o *GetConfiguredLicensesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /admin/tenants/{tenantID}/licenses] getConfiguredLicenses", response, response.Code())
	}
}
...
func (o *GetConfiguredLicensesOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/tenants/{tenantID}/licenses][%d] getConfiguredLicensesOK %s", 200, payload)
}
...
func (o *GetConfiguredLicensesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/tenants/{tenantID}/licenses][%d] getConfiguredLicensesUnauthorized %s", 401, payload)
}
...
func (o *GetConfiguredLicensesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/tenants/{tenantID}/licenses][%d] getConfiguredLicensesForbidden %s", 403, payload)
}
...
func (o *GetConfiguredLicensesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/tenants/{tenantID}/licenses][%d] getConfiguredLicensesNotFound %s", 404, payload)
}
...
func (o *GetConfiguredLicensesTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/tenants/{tenantID}/licenses][%d] getConfiguredLicensesTooManyRequests %s", 429, payload)
}
