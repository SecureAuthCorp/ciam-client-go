...
func (o *ImportConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /system/configuration] importConfiguration", response, response.Code())
	}
}
...
func (o *ImportConfigurationNoContent) Error() string {
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationNoContent", 204)
}
...
func (o *ImportConfigurationBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationBadRequest %s", 400, payload)
}
...
func (o *ImportConfigurationUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationUnauthorized %s", 401, payload)
}
...
func (o *ImportConfigurationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationForbidden %s", 403, payload)
}
...
func (o *ImportConfigurationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationNotFound %s", 404, payload)
}
...
func (o *ImportConfigurationConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationConflict %s", 409, payload)
}
...
func (o *ImportConfigurationUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationUnprocessableEntity %s", 422, payload)
}
...
func (o *ImportConfigurationTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/configuration][%d] importConfigurationTooManyRequests %s", 429, payload)
}
