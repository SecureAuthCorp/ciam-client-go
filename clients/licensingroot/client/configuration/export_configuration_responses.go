...
func (o *ExportConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /system/configuration] exportConfiguration", response, response.Code())
	}
}
...
func (o *ExportConfigurationOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationOK %s", 200, payload)
}
...
func (o *ExportConfigurationBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationBadRequest %s", 400, payload)
}
...
func (o *ExportConfigurationUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationUnauthorized %s", 401, payload)
}
...
func (o *ExportConfigurationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationForbidden %s", 403, payload)
}
...
func (o *ExportConfigurationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationNotFound %s", 404, payload)
}
...
func (o *ExportConfigurationUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationUnprocessableEntity %s", 422, payload)
}
...
func (o *ExportConfigurationTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/configuration][%d] exportConfigurationTooManyRequests %s", 429, payload)
}
