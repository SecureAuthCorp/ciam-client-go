...
func (o *PatchConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /system/configuration] patchConfiguration", response, response.Code())
	}
}
...
func (o *PatchConfigurationNoContent) Error() string {
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationNoContent", 204)
}
...
func (o *PatchConfigurationBadRequest) Error() string {
	...
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationBadRequest %s", 400, payload)
}
...
func (o *PatchConfigurationUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationUnauthorized %s", 401, payload)
}
...
func (o *PatchConfigurationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationForbidden %s", 403, payload)
}
...
func (o *PatchConfigurationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationNotFound %s", 404, payload)
}
...
func (o *PatchConfigurationUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationUnprocessableEntity %s", 422, payload)
}
...
func (o *PatchConfigurationTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /system/configuration][%d] patchConfigurationTooManyRequests %s", 429, payload)
}
