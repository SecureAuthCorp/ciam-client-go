...
func (m *UserWithData) validatePreferences(formats strfmt.Registry) error {
...
func (m *UserWithData) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
