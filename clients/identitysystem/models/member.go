...
type Member struct {
	...
	// type
	Type MemberType `json:"type,omitempty" yaml:"type,omitempty"`
...
func (m *Member) validateType(formats strfmt.Registry) error {
...
func (m *Member) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
