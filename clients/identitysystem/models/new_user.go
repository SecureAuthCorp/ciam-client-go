...
func (m *NewUser) validatePreferences(formats strfmt.Registry) error {
...
func (m *NewUser) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
