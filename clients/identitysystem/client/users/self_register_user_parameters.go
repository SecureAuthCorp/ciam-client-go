...
// WithXCorrelationID adds the xCorrelationID to the self register user params
func (o *SelfRegisterUserParams) WithXCorrelationID(xCorrelationID *string) *SelfRegisterUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the self register user params
func (o *SelfRegisterUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the self register user params
func (o *SelfRegisterUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *SelfRegisterUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the self register user params
func (o *SelfRegisterUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
