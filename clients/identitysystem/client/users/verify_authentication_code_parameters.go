...
// WithXCorrelationID adds the xCorrelationID to the verify authentication code params
func (o *VerifyAuthenticationCodeParams) WithXCorrelationID(xCorrelationID *string) *VerifyAuthenticationCodeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the verify authentication code params
func (o *VerifyAuthenticationCodeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the verify authentication code params
func (o *VerifyAuthenticationCodeParams) WithXIdempotencyKey(xIdempotencyKey *string) *VerifyAuthenticationCodeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the verify authentication code params
func (o *VerifyAuthenticationCodeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
