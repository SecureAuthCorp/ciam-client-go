...
// WithXCorrelationID adds the xCorrelationID to the generate code params
func (o *GenerateCodeParams) WithXCorrelationID(xCorrelationID *string) *GenerateCodeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the generate code params
func (o *GenerateCodeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the generate code params
func (o *GenerateCodeParams) WithXIdempotencyKey(xIdempotencyKey *string) *GenerateCodeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the generate code params
func (o *GenerateCodeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
