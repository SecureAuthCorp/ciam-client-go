...
// WithXCorrelationID adds the xCorrelationID to the system create user params
func (o *SystemCreateUserParams) WithXCorrelationID(xCorrelationID *string) *SystemCreateUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system create user params
func (o *SystemCreateUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system create user params
func (o *SystemCreateUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemCreateUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system create user params
func (o *SystemCreateUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
