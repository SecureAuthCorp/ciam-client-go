...
func (o *ChangePasswordParams) WithIPID(iPID string) *ChangePasswordParams {
	o.SetIPID(iPID)
	return o
}
...
// WithXCorrelationID adds the xCorrelationID to the change password params
func (o *ChangePasswordParams) WithXCorrelationID(xCorrelationID *string) *ChangePasswordParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the change password params
func (o *ChangePasswordParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the change password params
func (o *ChangePasswordParams) WithXIdempotencyKey(xIdempotencyKey *string) *ChangePasswordParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the change password params
func (o *ChangePasswordParams) SetXIdempotencyKey(xIdempotencyKey *string) {
