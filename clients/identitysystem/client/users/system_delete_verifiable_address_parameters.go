...
// WithXCorrelationID adds the xCorrelationID to the system delete verifiable address params
func (o *SystemDeleteVerifiableAddressParams) WithXCorrelationID(xCorrelationID *string) *SystemDeleteVerifiableAddressParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system delete verifiable address params
func (o *SystemDeleteVerifiableAddressParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system delete verifiable address params
func (o *SystemDeleteVerifiableAddressParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemDeleteVerifiableAddressParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system delete verifiable address params
func (o *SystemDeleteVerifiableAddressParams) SetXIdempotencyKey(xIdempotencyKey *string) {
