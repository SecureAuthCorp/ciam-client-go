...
// WithXCorrelationID adds the xCorrelationID to the system get user params
func (o *SystemGetUserParams) WithXCorrelationID(xCorrelationID *string) *SystemGetUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system get user params
func (o *SystemGetUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system get user params
func (o *SystemGetUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemGetUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system get user params
func (o *SystemGetUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
