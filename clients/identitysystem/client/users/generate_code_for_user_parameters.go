...
// WithXCorrelationID adds the xCorrelationID to the generate code for user params
func (o *GenerateCodeForUserParams) WithXCorrelationID(xCorrelationID *string) *GenerateCodeForUserParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the generate code for user params
func (o *GenerateCodeForUserParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the generate code for user params
func (o *GenerateCodeForUserParams) WithXIdempotencyKey(xIdempotencyKey *string) *GenerateCodeForUserParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the generate code for user params
func (o *GenerateCodeForUserParams) SetXIdempotencyKey(xIdempotencyKey *string) {
