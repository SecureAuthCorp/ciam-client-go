...
// WithXCorrelationID adds the xCorrelationID to the self send activation message params
func (o *SelfSendActivationMessageParams) WithXCorrelationID(xCorrelationID *string) *SelfSendActivationMessageParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the self send activation message params
func (o *SelfSendActivationMessageParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the self send activation message params
func (o *SelfSendActivationMessageParams) WithXIdempotencyKey(xIdempotencyKey *string) *SelfSendActivationMessageParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the self send activation message params
func (o *SelfSendActivationMessageParams) SetXIdempotencyKey(xIdempotencyKey *string) {
