...
// WithXCorrelationID adds the xCorrelationID to the verify o t p params
func (o *VerifyOTPParams) WithXCorrelationID(xCorrelationID *string) *VerifyOTPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the verify o t p params
func (o *VerifyOTPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the verify o t p params
func (o *VerifyOTPParams) WithXIdempotencyKey(xIdempotencyKey *string) *VerifyOTPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the verify o t p params
func (o *VerifyOTPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
