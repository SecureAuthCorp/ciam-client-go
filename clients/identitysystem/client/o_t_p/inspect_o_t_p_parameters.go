...
// WithXCorrelationID adds the xCorrelationID to the inspect o t p params
func (o *InspectOTPParams) WithXCorrelationID(xCorrelationID *string) *InspectOTPParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the inspect o t p params
func (o *InspectOTPParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the inspect o t p params
func (o *InspectOTPParams) WithXIdempotencyKey(xIdempotencyKey *string) *InspectOTPParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the inspect o t p params
func (o *InspectOTPParams) SetXIdempotencyKey(xIdempotencyKey *string) {
