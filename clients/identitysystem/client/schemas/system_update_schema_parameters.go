...
// WithXCorrelationID adds the xCorrelationID to the system update schema params
func (o *SystemUpdateSchemaParams) WithXCorrelationID(xCorrelationID *string) *SystemUpdateSchemaParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system update schema params
func (o *SystemUpdateSchemaParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system update schema params
func (o *SystemUpdateSchemaParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemUpdateSchemaParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system update schema params
func (o *SystemUpdateSchemaParams) SetXIdempotencyKey(xIdempotencyKey *string) {
