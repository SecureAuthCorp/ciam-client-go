...
// WithXCorrelationID adds the xCorrelationID to the system list schemas params
func (o *SystemListSchemasParams) WithXCorrelationID(xCorrelationID *string) *SystemListSchemasParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system list schemas params
func (o *SystemListSchemasParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system list schemas params
func (o *SystemListSchemasParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemListSchemasParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system list schemas params
func (o *SystemListSchemasParams) SetXIdempotencyKey(xIdempotencyKey *string) {
