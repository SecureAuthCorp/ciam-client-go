...
// WithXCorrelationID adds the xCorrelationID to the system create schema params
func (o *SystemCreateSchemaParams) WithXCorrelationID(xCorrelationID *string) *SystemCreateSchemaParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the system create schema params
func (o *SystemCreateSchemaParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the system create schema params
func (o *SystemCreateSchemaParams) WithXIdempotencyKey(xIdempotencyKey *string) *SystemCreateSchemaParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the system create schema params
func (o *SystemCreateSchemaParams) SetXIdempotencyKey(xIdempotencyKey *string) {
