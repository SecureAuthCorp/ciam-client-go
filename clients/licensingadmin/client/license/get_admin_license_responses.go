...
func (o *GetAdminLicenseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /admin/license] getAdminLicense", response, response.Code())
	}
}
...
func (o *GetAdminLicenseOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/license][%d] getAdminLicenseOK %s", 200, payload)
}
...
func (o *GetAdminLicenseUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/license][%d] getAdminLicenseUnauthorized %s", 401, payload)
}
...
func (o *GetAdminLicenseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/license][%d] getAdminLicenseForbidden %s", 403, payload)
}
...
func (o *GetAdminLicenseNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/license][%d] getAdminLicenseNotFound %s", 404, payload)
}
...
func (o *GetAdminLicenseTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/license][%d] getAdminLicenseTooManyRequests %s", 429, payload)
}
