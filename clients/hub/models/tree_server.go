...
func (m *TreeServer) validatePreferences(formats strfmt.Registry) error {
...
const (
	...
	// TreeServerProfileAgenticAi captures enum value "agentic_ai"
	TreeServerProfileAgenticAi string = "agentic_ai"

	// TreeServerProfileSaidpLegacy captures enum value "saidp_legacy"
	TreeServerProfileSaidpLegacy string = "saidp_legacy"
)
...
func (m *TreeServer) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
