...
// WithXCorrelationID adds the xCorrelationID to the revoke tenant role params
func (o *RevokeTenantRoleParams) WithXCorrelationID(xCorrelationID *string) *RevokeTenantRoleParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the revoke tenant role params
func (o *RevokeTenantRoleParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the revoke tenant role params
func (o *RevokeTenantRoleParams) WithXIdempotencyKey(xIdempotencyKey *string) *RevokeTenantRoleParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the revoke tenant role params
func (o *RevokeTenantRoleParams) SetXIdempotencyKey(xIdempotencyKey *string) {
