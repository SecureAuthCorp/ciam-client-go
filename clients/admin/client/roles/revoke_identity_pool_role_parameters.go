...
// WithXCorrelationID adds the xCorrelationID to the revoke identity pool role params
func (o *RevokeIdentityPoolRoleParams) WithXCorrelationID(xCorrelationID *string) *RevokeIdentityPoolRoleParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the revoke identity pool role params
func (o *RevokeIdentityPoolRoleParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the revoke identity pool role params
func (o *RevokeIdentityPoolRoleParams) WithXIdempotencyKey(xIdempotencyKey *string) *RevokeIdentityPoolRoleParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the revoke identity pool role params
func (o *RevokeIdentityPoolRoleParams) SetXIdempotencyKey(xIdempotencyKey *string) {
