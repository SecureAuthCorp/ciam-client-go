...
// WithXCorrelationID adds the xCorrelationID to the grant tenant role params
func (o *GrantTenantRoleParams) WithXCorrelationID(xCorrelationID *string) *GrantTenantRoleParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the grant tenant role params
func (o *GrantTenantRoleParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the grant tenant role params
func (o *GrantTenantRoleParams) WithXIdempotencyKey(xIdempotencyKey *string) *GrantTenantRoleParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the grant tenant role params
func (o *GrantTenantRoleParams) SetXIdempotencyKey(xIdempotencyKey *string) {
