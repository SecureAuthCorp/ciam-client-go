...
// WithXCorrelationID adds the xCorrelationID to the list workspace roles params
func (o *ListWorkspaceRolesParams) WithXCorrelationID(xCorrelationID *string) *ListWorkspaceRolesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list workspace roles params
func (o *ListWorkspaceRolesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list workspace roles params
func (o *ListWorkspaceRolesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListWorkspaceRolesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list workspace roles params
func (o *ListWorkspaceRolesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
