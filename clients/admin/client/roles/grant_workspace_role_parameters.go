...
// WithXCorrelationID adds the xCorrelationID to the grant workspace role params
func (o *GrantWorkspaceRoleParams) WithXCorrelationID(xCorrelationID *string) *GrantWorkspaceRoleParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the grant workspace role params
func (o *GrantWorkspaceRoleParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the grant workspace role params
func (o *GrantWorkspaceRoleParams) WithXIdempotencyKey(xIdempotencyKey *string) *GrantWorkspaceRoleParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the grant workspace role params
func (o *GrantWorkspaceRoleParams) SetXIdempotencyKey(xIdempotencyKey *string) {
