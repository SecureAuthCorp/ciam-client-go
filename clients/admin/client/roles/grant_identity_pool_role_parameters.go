...
// WithXCorrelationID adds the xCorrelationID to the grant identity pool role params
func (o *GrantIdentityPoolRoleParams) WithXCorrelationID(xCorrelationID *string) *GrantIdentityPoolRoleParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the grant identity pool role params
func (o *GrantIdentityPoolRoleParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the grant identity pool role params
func (o *GrantIdentityPoolRoleParams) WithXIdempotencyKey(xIdempotencyKey *string) *GrantIdentityPoolRoleParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the grant identity pool role params
func (o *GrantIdentityPoolRoleParams) SetXIdempotencyKey(xIdempotencyKey *string) {
