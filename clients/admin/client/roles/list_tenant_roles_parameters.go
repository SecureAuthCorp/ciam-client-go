...
// WithXCorrelationID adds the xCorrelationID to the list tenant roles params
func (o *ListTenantRolesParams) WithXCorrelationID(xCorrelationID *string) *ListTenantRolesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list tenant roles params
func (o *ListTenantRolesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list tenant roles params
func (o *ListTenantRolesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListTenantRolesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list tenant roles params
func (o *ListTenantRolesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
