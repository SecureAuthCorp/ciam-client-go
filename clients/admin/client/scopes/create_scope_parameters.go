...
// WithXCorrelationID adds the xCorrelationID to the create scope params
func (o *CreateScopeParams) WithXCorrelationID(xCorrelationID *string) *CreateScopeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create scope params
func (o *CreateScopeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create scope params
func (o *CreateScopeParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateScopeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create scope params
func (o *CreateScopeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
