...
// WithXCorrelationID adds the xCorrelationID to the delete scope params
func (o *DeleteScopeParams) WithXCorrelationID(xCorrelationID *string) *DeleteScopeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete scope params
func (o *DeleteScopeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete scope params
func (o *DeleteScopeParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteScopeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete scope params
func (o *DeleteScopeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
