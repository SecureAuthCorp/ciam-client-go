...
// WithXCorrelationID adds the xCorrelationID to the create m f a method params
func (o *CreateMFAMethodParams) WithXCorrelationID(xCorrelationID *string) *CreateMFAMethodParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create m f a method params
func (o *CreateMFAMethodParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create m f a method params
func (o *CreateMFAMethodParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateMFAMethodParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create m f a method params
func (o *CreateMFAMethodParams) SetXIdempotencyKey(xIdempotencyKey *string) {
