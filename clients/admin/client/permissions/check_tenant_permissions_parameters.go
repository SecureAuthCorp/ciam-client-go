...
// WithXCorrelationID adds the xCorrelationID to the check tenant permissions params
func (o *CheckTenantPermissionsParams) WithXCorrelationID(xCorrelationID *string) *CheckTenantPermissionsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the check tenant permissions params
func (o *CheckTenantPermissionsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the check tenant permissions params
func (o *CheckTenantPermissionsParams) WithXIdempotencyKey(xIdempotencyKey *string) *CheckTenantPermissionsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the check tenant permissions params
func (o *CheckTenantPermissionsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
