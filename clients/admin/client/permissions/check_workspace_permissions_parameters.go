...
// WithXCorrelationID adds the xCorrelationID to the check workspace permissions params
func (o *CheckWorkspacePermissionsParams) WithXCorrelationID(xCorrelationID *string) *CheckWorkspacePermissionsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the check workspace permissions params
func (o *CheckWorkspacePermissionsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the check workspace permissions params
func (o *CheckWorkspacePermissionsParams) WithXIdempotencyKey(xIdempotencyKey *string) *CheckWorkspacePermissionsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the check workspace permissions params
func (o *CheckWorkspacePermissionsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
