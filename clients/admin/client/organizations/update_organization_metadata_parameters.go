...
// WithXCorrelationID adds the xCorrelationID to the update organization metadata params
func (o *UpdateOrganizationMetadataParams) WithXCorrelationID(xCorrelationID *string) *UpdateOrganizationMetadataParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update organization metadata params
func (o *UpdateOrganizationMetadataParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update organization metadata params
func (o *UpdateOrganizationMetadataParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateOrganizationMetadataParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update organization metadata params
func (o *UpdateOrganizationMetadataParams) SetXIdempotencyKey(xIdempotencyKey *string) {
