...
// WithXCorrelationID adds the xCorrelationID to the list user organizations params
func (o *ListUserOrganizationsParams) WithXCorrelationID(xCorrelationID *string) *ListUserOrganizationsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list user organizations params
func (o *ListUserOrganizationsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list user organizations params
func (o *ListUserOrganizationsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListUserOrganizationsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list user organizations params
func (o *ListUserOrganizationsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
