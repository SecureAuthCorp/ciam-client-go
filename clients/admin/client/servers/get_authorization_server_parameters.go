...
// WithXCorrelationID adds the xCorrelationID to the get authorization server params
func (o *GetAuthorizationServerParams) WithXCorrelationID(xCorrelationID *string) *GetAuthorizationServerParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get authorization server params
func (o *GetAuthorizationServerParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get authorization server params
func (o *GetAuthorizationServerParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAuthorizationServerParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get authorization server params
func (o *GetAuthorizationServerParams) SetXIdempotencyKey(xIdempotencyKey *string) {
