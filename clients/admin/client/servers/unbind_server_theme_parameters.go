...
// WithXCorrelationID adds the xCorrelationID to the unbind server theme params
func (o *UnbindServerThemeParams) WithXCorrelationID(xCorrelationID *string) *UnbindServerThemeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the unbind server theme params
func (o *UnbindServerThemeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the unbind server theme params
func (o *UnbindServerThemeParams) WithXIdempotencyKey(xIdempotencyKey *string) *UnbindServerThemeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the unbind server theme params
func (o *UnbindServerThemeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
