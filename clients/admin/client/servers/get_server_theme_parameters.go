...
// WithXCorrelationID adds the xCorrelationID to the get server theme params
func (o *GetServerThemeParams) WithXCorrelationID(xCorrelationID *string) *GetServerThemeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get server theme params
func (o *GetServerThemeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get server theme params
func (o *GetServerThemeParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetServerThemeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get server theme params
func (o *GetServerThemeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
