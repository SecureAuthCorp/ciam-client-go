...
// WithXCorrelationID adds the xCorrelationID to the set c i b a authentication service params
func (o *SetCIBAAuthenticationServiceParams) WithXCorrelationID(xCorrelationID *string) *SetCIBAAuthenticationServiceParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set c i b a authentication service params
func (o *SetCIBAAuthenticationServiceParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set c i b a authentication service params
func (o *SetCIBAAuthenticationServiceParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetCIBAAuthenticationServiceParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set c i b a authentication service params
func (o *SetCIBAAuthenticationServiceParams) SetXIdempotencyKey(xIdempotencyKey *string) {
