...
// WithXCorrelationID adds the xCorrelationID to the unbind server params
func (o *UnbindServerParams) WithXCorrelationID(xCorrelationID *string) *UnbindServerParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the unbind server params
func (o *UnbindServerParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the unbind server params
func (o *UnbindServerParams) WithXIdempotencyKey(xIdempotencyKey *string) *UnbindServerParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the unbind server params
func (o *UnbindServerParams) SetXIdempotencyKey(xIdempotencyKey *string) {
