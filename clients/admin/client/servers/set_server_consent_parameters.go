...
// WithXCorrelationID adds the xCorrelationID to the set server consent params
func (o *SetServerConsentParams) WithXCorrelationID(xCorrelationID *string) *SetServerConsentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set server consent params
func (o *SetServerConsentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set server consent params
func (o *SetServerConsentParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetServerConsentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set server consent params
func (o *SetServerConsentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
