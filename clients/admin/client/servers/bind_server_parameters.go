...
// WithXCorrelationID adds the xCorrelationID to the bind server params
func (o *BindServerParams) WithXCorrelationID(xCorrelationID *string) *BindServerParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the bind server params
func (o *BindServerParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the bind server params
func (o *BindServerParams) WithXIdempotencyKey(xIdempotencyKey *string) *BindServerParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the bind server params
func (o *BindServerParams) SetXIdempotencyKey(xIdempotencyKey *string) {
