...
// WithXCorrelationID adds the xCorrelationID to the create consent params
func (o *CreateConsentParams) WithXCorrelationID(xCorrelationID *string) *CreateConsentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create consent params
func (o *CreateConsentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create consent params
func (o *CreateConsentParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateConsentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create consent params
func (o *CreateConsentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
