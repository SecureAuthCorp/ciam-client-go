...
// WithXCorrelationID adds the xCorrelationID to the update consent action params
func (o *UpdateConsentActionParams) WithXCorrelationID(xCorrelationID *string) *UpdateConsentActionParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update consent action params
func (o *UpdateConsentActionParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update consent action params
func (o *UpdateConsentActionParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateConsentActionParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update consent action params
func (o *UpdateConsentActionParams) SetXIdempotencyKey(xIdempotencyKey *string) {
