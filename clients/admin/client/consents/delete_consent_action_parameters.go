...
// WithXCorrelationID adds the xCorrelationID to the delete consent action params
func (o *DeleteConsentActionParams) WithXCorrelationID(xCorrelationID *string) *DeleteConsentActionParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete consent action params
func (o *DeleteConsentActionParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete consent action params
func (o *DeleteConsentActionParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteConsentActionParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete consent action params
func (o *DeleteConsentActionParams) SetXIdempotencyKey(xIdempotencyKey *string) {
