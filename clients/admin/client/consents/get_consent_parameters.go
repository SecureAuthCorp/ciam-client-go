...
// WithXCorrelationID adds the xCorrelationID to the get consent params
func (o *GetConsentParams) WithXCorrelationID(xCorrelationID *string) *GetConsentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get consent params
func (o *GetConsentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get consent params
func (o *GetConsentParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetConsentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get consent params
func (o *GetConsentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
