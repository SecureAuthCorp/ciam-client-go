...
// WithXCorrelationID adds the xCorrelationID to the list consents params
func (o *ListConsentsParams) WithXCorrelationID(xCorrelationID *string) *ListConsentsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list consents params
func (o *ListConsentsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list consents params
func (o *ListConsentsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListConsentsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list consents params
func (o *ListConsentsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
