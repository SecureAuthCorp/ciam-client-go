...
// WithXCorrelationID adds the xCorrelationID to the delete consent params
func (o *DeleteConsentParams) WithXCorrelationID(xCorrelationID *string) *DeleteConsentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete consent params
func (o *DeleteConsentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete consent params
func (o *DeleteConsentParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteConsentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete consent params
func (o *DeleteConsentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
