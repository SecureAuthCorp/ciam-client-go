...
// WithXCorrelationID adds the xCorrelationID to the update consent params
func (o *UpdateConsentParams) WithXCorrelationID(xCorrelationID *string) *UpdateConsentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update consent params
func (o *UpdateConsentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update consent params
func (o *UpdateConsentParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateConsentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update consent params
func (o *UpdateConsentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
