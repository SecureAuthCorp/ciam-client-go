...
// WithXCorrelationID adds the xCorrelationID to the get openbanking package params
func (o *GetOpenbankingPackageParams) WithXCorrelationID(xCorrelationID *string) *GetOpenbankingPackageParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get openbanking package params
func (o *GetOpenbankingPackageParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get openbanking package params
func (o *GetOpenbankingPackageParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetOpenbankingPackageParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get openbanking package params
func (o *GetOpenbankingPackageParams) SetXIdempotencyKey(xIdempotencyKey *string) {
