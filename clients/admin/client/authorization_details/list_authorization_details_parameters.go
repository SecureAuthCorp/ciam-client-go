...
// WithXCorrelationID adds the xCorrelationID to the list authorization details params
func (o *ListAuthorizationDetailsParams) WithXCorrelationID(xCorrelationID *string) *ListAuthorizationDetailsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list authorization details params
func (o *ListAuthorizationDetailsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list authorization details params
func (o *ListAuthorizationDetailsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListAuthorizationDetailsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list authorization details params
func (o *ListAuthorizationDetailsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
