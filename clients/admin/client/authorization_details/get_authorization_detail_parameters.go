...
// WithXCorrelationID adds the xCorrelationID to the get authorization detail params
func (o *GetAuthorizationDetailParams) WithXCorrelationID(xCorrelationID *string) *GetAuthorizationDetailParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get authorization detail params
func (o *GetAuthorizationDetailParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get authorization detail params
func (o *GetAuthorizationDetailParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAuthorizationDetailParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get authorization detail params
func (o *GetAuthorizationDetailParams) SetXIdempotencyKey(xIdempotencyKey *string) {
