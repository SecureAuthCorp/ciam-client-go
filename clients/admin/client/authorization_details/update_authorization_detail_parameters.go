...
// WithXCorrelationID adds the xCorrelationID to the update authorization detail params
func (o *UpdateAuthorizationDetailParams) WithXCorrelationID(xCorrelationID *string) *UpdateAuthorizationDetailParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update authorization detail params
func (o *UpdateAuthorizationDetailParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update authorization detail params
func (o *UpdateAuthorizationDetailParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAuthorizationDetailParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update authorization detail params
func (o *UpdateAuthorizationDetailParams) SetXIdempotencyKey(xIdempotencyKey *string) {
