...
// WithXCorrelationID adds the xCorrelationID to the delete authorization detail params
func (o *DeleteAuthorizationDetailParams) WithXCorrelationID(xCorrelationID *string) *DeleteAuthorizationDetailParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete authorization detail params
func (o *DeleteAuthorizationDetailParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete authorization detail params
func (o *DeleteAuthorizationDetailParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteAuthorizationDetailParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete authorization detail params
func (o *DeleteAuthorizationDetailParams) SetXIdempotencyKey(xIdempotencyKey *string) {
