...
// WithXCorrelationID adds the xCorrelationID to the get API params
func (o *GetAPIParams) WithXCorrelationID(xCorrelationID *string) *GetAPIParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get API params
func (o *GetAPIParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get API params
func (o *GetAPIParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAPIParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get API params
func (o *GetAPIParams) SetXIdempotencyKey(xIdempotencyKey *string) {
