...
// WithXCorrelationID adds the xCorrelationID to the list a p is by server params
func (o *ListAPIsByServerParams) WithXCorrelationID(xCorrelationID *string) *ListAPIsByServerParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list a p is by server params
func (o *ListAPIsByServerParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list a p is by server params
func (o *ListAPIsByServerParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListAPIsByServerParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list a p is by server params
func (o *ListAPIsByServerParams) SetXIdempotencyKey(xIdempotencyKey *string) {
