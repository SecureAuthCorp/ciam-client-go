...
// WithXCorrelationID adds the xCorrelationID to the update API params
func (o *UpdateAPIParams) WithXCorrelationID(xCorrelationID *string) *UpdateAPIParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update API params
func (o *UpdateAPIParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update API params
func (o *UpdateAPIParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAPIParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update API params
func (o *UpdateAPIParams) SetXIdempotencyKey(xIdempotencyKey *string) {
