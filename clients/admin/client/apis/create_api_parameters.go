...
// WithXCorrelationID adds the xCorrelationID to the create API params
func (o *CreateAPIParams) WithXCorrelationID(xCorrelationID *string) *CreateAPIParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create API params
func (o *CreateAPIParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create API params
func (o *CreateAPIParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateAPIParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create API params
func (o *CreateAPIParams) SetXIdempotencyKey(xIdempotencyKey *string) {
