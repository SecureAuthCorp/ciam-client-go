...
// WithXCorrelationID adds the xCorrelationID to the delete API params
func (o *DeleteAPIParams) WithXCorrelationID(xCorrelationID *string) *DeleteAPIParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete API params
func (o *DeleteAPIParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete API params
func (o *DeleteAPIParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteAPIParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete API params
func (o *DeleteAPIParams) SetXIdempotencyKey(xIdempotencyKey *string) {
