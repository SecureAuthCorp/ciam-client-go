...
// WithXCorrelationID adds the xCorrelationID to the list user workspaces params
func (o *ListUserWorkspacesParams) WithXCorrelationID(xCorrelationID *string) *ListUserWorkspacesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list user workspaces params
func (o *ListUserWorkspacesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list user workspaces params
func (o *ListUserWorkspacesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListUserWorkspacesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list user workspaces params
func (o *ListUserWorkspacesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
