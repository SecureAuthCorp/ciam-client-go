...
func (o *ListWorkspacesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /workspaces] listWorkspaces", response, response.Code())
	}
}
...
func (o *ListWorkspacesOK) Error() string {
	...
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesOK %s", 200, payload)
}
...
func (o *ListWorkspacesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesUnauthorized %s", 401, payload)
}
...
func (o *ListWorkspacesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesForbidden %s", 403, payload)
}
...
func (o *ListWorkspacesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesNotFound %s", 404, payload)
}
...
func (o *ListWorkspacesTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesTooManyRequests %s", 429, payload)
}
