...
// WithXCorrelationID adds the xCorrelationID to the update workspace metadata params
func (o *UpdateWorkspaceMetadataParams) WithXCorrelationID(xCorrelationID *string) *UpdateWorkspaceMetadataParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update workspace metadata params
func (o *UpdateWorkspaceMetadataParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update workspace metadata params
func (o *UpdateWorkspaceMetadataParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateWorkspaceMetadataParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update workspace metadata params
func (o *UpdateWorkspaceMetadataParams) SetXIdempotencyKey(xIdempotencyKey *string) {
