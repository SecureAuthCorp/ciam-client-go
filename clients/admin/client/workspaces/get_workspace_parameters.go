...
// WithXCorrelationID adds the xCorrelationID to the get workspace params
func (o *GetWorkspaceParams) WithXCorrelationID(xCorrelationID *string) *GetWorkspaceParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get workspace params
func (o *GetWorkspaceParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get workspace params
func (o *GetWorkspaceParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetWorkspaceParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get workspace params
func (o *GetWorkspaceParams) SetXIdempotencyKey(xIdempotencyKey *string) {
