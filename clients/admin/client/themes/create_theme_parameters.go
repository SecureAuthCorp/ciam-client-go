...
// WithXCorrelationID adds the xCorrelationID to the create theme params
func (o *CreateThemeParams) WithXCorrelationID(xCorrelationID *string) *CreateThemeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create theme params
func (o *CreateThemeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create theme params
func (o *CreateThemeParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateThemeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create theme params
func (o *CreateThemeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
