...
// WithXCorrelationID adds the xCorrelationID to the update theme params
func (o *UpdateThemeParams) WithXCorrelationID(xCorrelationID *string) *UpdateThemeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update theme params
func (o *UpdateThemeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update theme params
func (o *UpdateThemeParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateThemeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update theme params
func (o *UpdateThemeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
