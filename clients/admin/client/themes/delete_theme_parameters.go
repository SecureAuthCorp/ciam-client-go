...
// WithXCorrelationID adds the xCorrelationID to the delete theme params
func (o *DeleteThemeParams) WithXCorrelationID(xCorrelationID *string) *DeleteThemeParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete theme params
func (o *DeleteThemeParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete theme params
func (o *DeleteThemeParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteThemeParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete theme params
func (o *DeleteThemeParams) SetXIdempotencyKey(xIdempotencyKey *string) {
