...
// WithXCorrelationID adds the xCorrelationID to the get custom app params
func (o *GetCustomAppParams) WithXCorrelationID(xCorrelationID *string) *GetCustomAppParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get custom app params
func (o *GetCustomAppParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get custom app params
func (o *GetCustomAppParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetCustomAppParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get custom app params
func (o *GetCustomAppParams) SetXIdempotencyKey(xIdempotencyKey *string) {
