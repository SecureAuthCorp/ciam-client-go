...
// WithXCorrelationID adds the xCorrelationID to the create custom app params
func (o *CreateCustomAppParams) WithXCorrelationID(xCorrelationID *string) *CreateCustomAppParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create custom app params
func (o *CreateCustomAppParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create custom app params
func (o *CreateCustomAppParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateCustomAppParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create custom app params
func (o *CreateCustomAppParams) SetXIdempotencyKey(xIdempotencyKey *string) {
