...
// WithXCorrelationID adds the xCorrelationID to the delete custom app params
func (o *DeleteCustomAppParams) WithXCorrelationID(xCorrelationID *string) *DeleteCustomAppParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete custom app params
func (o *DeleteCustomAppParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete custom app params
func (o *DeleteCustomAppParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteCustomAppParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete custom app params
func (o *DeleteCustomAppParams) SetXIdempotencyKey(xIdempotencyKey *string) {
