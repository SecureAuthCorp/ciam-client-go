...
// WithXCorrelationID adds the xCorrelationID to the update vanity domain params
func (o *UpdateVanityDomainParams) WithXCorrelationID(xCorrelationID *string) *UpdateVanityDomainParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update vanity domain params
func (o *UpdateVanityDomainParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update vanity domain params
func (o *UpdateVanityDomainParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateVanityDomainParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update vanity domain params
func (o *UpdateVanityDomainParams) SetXIdempotencyKey(xIdempotencyKey *string) {
