...
// NewDeleteVanityDomainParams creates a new DeleteVanityDomainParams object,
...
func NewDeleteVanityDomainParams() *DeleteVanityDomainParams {
	return &DeleteVanityDomainParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteVanityDomainParamsWithTimeout creates a new DeleteVanityDomainParams object
...
// NewDeleteVanityDomainParamsWithContext creates a new DeleteVanityDomainParams object
...
// NewDeleteVanityDomainParamsWithHTTPClient creates a new DeleteVanityDomainParams object
...
// WithXCorrelationID adds the xCorrelationID to the delete vanity domain params
func (o *DeleteVanityDomainParams) WithXCorrelationID(xCorrelationID *string) *DeleteVanityDomainParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete vanity domain params
func (o *DeleteVanityDomainParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete vanity domain params
func (o *DeleteVanityDomainParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteVanityDomainParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete vanity domain params
func (o *DeleteVanityDomainParams) SetXIdempotencyKey(xIdempotencyKey *string) {
