...
// WithXCorrelationID adds the xCorrelationID to the get vanity domain params
func (o *GetVanityDomainParams) WithXCorrelationID(xCorrelationID *string) *GetVanityDomainParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get vanity domain params
func (o *GetVanityDomainParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get vanity domain params
func (o *GetVanityDomainParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetVanityDomainParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get vanity domain params
func (o *GetVanityDomainParams) SetXIdempotencyKey(xIdempotencyKey *string) {
