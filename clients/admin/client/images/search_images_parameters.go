...
func (o *SearchImagesParams) SetDefaults() {
	var (
		qDefault = string("\"cloudentity\"")
	)

	val := SearchImagesParams{
		Q: &qDefault,
	}
...
// WithXCorrelationID adds the xCorrelationID to the search images params
func (o *SearchImagesParams) WithXCorrelationID(xCorrelationID *string) *SearchImagesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the search images params
func (o *SearchImagesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the search images params
func (o *SearchImagesParams) WithXIdempotencyKey(xIdempotencyKey *string) *SearchImagesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the search images params
func (o *SearchImagesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
