...
// WithXCorrelationID adds the xCorrelationID to the get workspace environment params
func (o *GetWorkspaceEnvironmentParams) WithXCorrelationID(xCorrelationID *string) *GetWorkspaceEnvironmentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get workspace environment params
func (o *GetWorkspaceEnvironmentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get workspace environment params
func (o *GetWorkspaceEnvironmentParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetWorkspaceEnvironmentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get workspace environment params
func (o *GetWorkspaceEnvironmentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
