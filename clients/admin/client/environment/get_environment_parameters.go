...
// WithXCorrelationID adds the xCorrelationID to the get environment params
func (o *GetEnvironmentParams) WithXCorrelationID(xCorrelationID *string) *GetEnvironmentParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get environment params
func (o *GetEnvironmentParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get environment params
func (o *GetEnvironmentParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetEnvironmentParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get environment params
func (o *GetEnvironmentParams) SetXIdempotencyKey(xIdempotencyKey *string) {
