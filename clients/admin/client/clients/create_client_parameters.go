...
// WithXCorrelationID adds the xCorrelationID to the create client params
func (o *CreateClientParams) WithXCorrelationID(xCorrelationID *string) *CreateClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create client params
func (o *CreateClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create client params
func (o *CreateClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create client params
func (o *CreateClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
