...
// WithXCorrelationID adds the xCorrelationID to the import s a m l metadata from file params
func (o *ImportSAMLMetadataFromFileParams) WithXCorrelationID(xCorrelationID *string) *ImportSAMLMetadataFromFileParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the import s a m l metadata from file params
func (o *ImportSAMLMetadataFromFileParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from file params
func (o *ImportSAMLMetadataFromFileParams) WithXIdempotencyKey(xIdempotencyKey *string) *ImportSAMLMetadataFromFileParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from file params
func (o *ImportSAMLMetadataFromFileParams) SetXIdempotencyKey(xIdempotencyKey *string) {
