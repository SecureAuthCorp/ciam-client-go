...
// WithXCorrelationID adds the xCorrelationID to the import s a m l metadata from text params
func (o *ImportSAMLMetadataFromTextParams) WithXCorrelationID(xCorrelationID *string) *ImportSAMLMetadataFromTextParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the import s a m l metadata from text params
func (o *ImportSAMLMetadataFromTextParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from text params
func (o *ImportSAMLMetadataFromTextParams) WithXIdempotencyKey(xIdempotencyKey *string) *ImportSAMLMetadataFromTextParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from text params
func (o *ImportSAMLMetadataFromTextParams) SetXIdempotencyKey(xIdempotencyKey *string) {
