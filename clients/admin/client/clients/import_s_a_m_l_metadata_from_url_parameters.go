...
// WithXCorrelationID adds the xCorrelationID to the import s a m l metadata from URL params
func (o *ImportSAMLMetadataFromURLParams) WithXCorrelationID(xCorrelationID *string) *ImportSAMLMetadataFromURLParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the import s a m l metadata from URL params
func (o *ImportSAMLMetadataFromURLParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from URL params
func (o *ImportSAMLMetadataFromURLParams) WithXIdempotencyKey(xIdempotencyKey *string) *ImportSAMLMetadataFromURLParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the import s a m l metadata from URL params
func (o *ImportSAMLMetadataFromURLParams) SetXIdempotencyKey(xIdempotencyKey *string) {
