...
// WithXCorrelationID adds the xCorrelationID to the list clients params
func (o *ListClientsParams) WithXCorrelationID(xCorrelationID *string) *ListClientsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list clients params
func (o *ListClientsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list clients params
func (o *ListClientsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListClientsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list clients params
func (o *ListClientsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
