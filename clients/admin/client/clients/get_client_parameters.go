...
// WithXCorrelationID adds the xCorrelationID to the get client params
func (o *GetClientParams) WithXCorrelationID(xCorrelationID *string) *GetClientParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get client params
func (o *GetClientParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get client params
func (o *GetClientParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetClientParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get client params
func (o *GetClientParams) SetXIdempotencyKey(xIdempotencyKey *string) {
