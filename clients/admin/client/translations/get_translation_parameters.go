...
// WithXCorrelationID adds the xCorrelationID to the get translation params
func (o *GetTranslationParams) WithXCorrelationID(xCorrelationID *string) *GetTranslationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get translation params
func (o *GetTranslationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get translation params
func (o *GetTranslationParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetTranslationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get translation params
func (o *GetTranslationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
