...
// WithXCorrelationID adds the xCorrelationID to the unbind system API params
func (o *UnbindSystemAPIParams) WithXCorrelationID(xCorrelationID *string) *UnbindSystemAPIParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the unbind system API params
func (o *UnbindSystemAPIParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the unbind system API params
func (o *UnbindSystemAPIParams) WithXIdempotencyKey(xIdempotencyKey *string) *UnbindSystemAPIParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the unbind system API params
func (o *UnbindSystemAPIParams) SetXIdempotencyKey(xIdempotencyKey *string) {
