...
// WithXCorrelationID adds the xCorrelationID to the list system a p is params
func (o *ListSystemAPIsParams) WithXCorrelationID(xCorrelationID *string) *ListSystemAPIsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list system a p is params
func (o *ListSystemAPIsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list system a p is params
func (o *ListSystemAPIsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListSystemAPIsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list system a p is params
func (o *ListSystemAPIsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
