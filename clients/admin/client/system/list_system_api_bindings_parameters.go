...
// WithXCorrelationID adds the xCorrelationID to the list system API bindings params
func (o *ListSystemAPIBindingsParams) WithXCorrelationID(xCorrelationID *string) *ListSystemAPIBindingsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list system API bindings params
func (o *ListSystemAPIBindingsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list system API bindings params
func (o *ListSystemAPIBindingsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListSystemAPIBindingsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list system API bindings params
func (o *ListSystemAPIBindingsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
