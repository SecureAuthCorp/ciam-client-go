...
// WithXCorrelationID adds the xCorrelationID to the revoke tokens params
func (o *RevokeTokensParams) WithXCorrelationID(xCorrelationID *string) *RevokeTokensParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the revoke tokens params
func (o *RevokeTokensParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the revoke tokens params
func (o *RevokeTokensParams) WithXIdempotencyKey(xIdempotencyKey *string) *RevokeTokensParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the revoke tokens params
func (o *RevokeTokensParams) SetXIdempotencyKey(xIdempotencyKey *string) {
