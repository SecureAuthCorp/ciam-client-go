...
// WithXCorrelationID adds the xCorrelationID to the update webhook params
func (o *UpdateWebhookParams) WithXCorrelationID(xCorrelationID *string) *UpdateWebhookParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update webhook params
func (o *UpdateWebhookParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update webhook params
func (o *UpdateWebhookParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateWebhookParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update webhook params
func (o *UpdateWebhookParams) SetXIdempotencyKey(xIdempotencyKey *string) {
