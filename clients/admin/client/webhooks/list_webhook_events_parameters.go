...
// WithXCorrelationID adds the xCorrelationID to the list webhook events params
func (o *ListWebhookEventsParams) WithXCorrelationID(xCorrelationID *string) *ListWebhookEventsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list webhook events params
func (o *ListWebhookEventsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list webhook events params
func (o *ListWebhookEventsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListWebhookEventsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list webhook events params
func (o *ListWebhookEventsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
