...
// WithXCorrelationID adds the xCorrelationID to the create webhook params
func (o *CreateWebhookParams) WithXCorrelationID(xCorrelationID *string) *CreateWebhookParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create webhook params
func (o *CreateWebhookParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create webhook params
func (o *CreateWebhookParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateWebhookParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create webhook params
func (o *CreateWebhookParams) SetXIdempotencyKey(xIdempotencyKey *string) {
