...
// WithXCorrelationID adds the xCorrelationID to the list server webhooks params
func (o *ListServerWebhooksParams) WithXCorrelationID(xCorrelationID *string) *ListServerWebhooksParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list server webhooks params
func (o *ListServerWebhooksParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list server webhooks params
func (o *ListServerWebhooksParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListServerWebhooksParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list server webhooks params
func (o *ListServerWebhooksParams) SetXIdempotencyKey(xIdempotencyKey *string) {
