...
// WithXCorrelationID adds the xCorrelationID to the get gateway package params
func (o *GetGatewayPackageParams) WithXCorrelationID(xCorrelationID *string) *GetGatewayPackageParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get gateway package params
func (o *GetGatewayPackageParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get gateway package params
func (o *GetGatewayPackageParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGatewayPackageParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get gateway package params
func (o *GetGatewayPackageParams) SetXIdempotencyKey(xIdempotencyKey *string) {
