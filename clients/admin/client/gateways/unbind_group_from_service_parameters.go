...
// WithXCorrelationID adds the xCorrelationID to the unbind group from service params
func (o *UnbindGroupFromServiceParams) WithXCorrelationID(xCorrelationID *string) *UnbindGroupFromServiceParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the unbind group from service params
func (o *UnbindGroupFromServiceParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the unbind group from service params
func (o *UnbindGroupFromServiceParams) WithXIdempotencyKey(xIdempotencyKey *string) *UnbindGroupFromServiceParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the unbind group from service params
func (o *UnbindGroupFromServiceParams) SetXIdempotencyKey(xIdempotencyKey *string) {
