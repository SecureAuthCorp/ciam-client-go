...
// WithXCorrelationID adds the xCorrelationID to the list gateways params
func (o *ListGatewaysParams) WithXCorrelationID(xCorrelationID *string) *ListGatewaysParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list gateways params
func (o *ListGatewaysParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list gateways params
func (o *ListGatewaysParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListGatewaysParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list gateways params
func (o *ListGatewaysParams) SetXIdempotencyKey(xIdempotencyKey *string) {
