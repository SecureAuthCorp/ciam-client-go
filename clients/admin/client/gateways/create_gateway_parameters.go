...
// WithXCorrelationID adds the xCorrelationID to the create gateway params
func (o *CreateGatewayParams) WithXCorrelationID(xCorrelationID *string) *CreateGatewayParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create gateway params
func (o *CreateGatewayParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create gateway params
func (o *CreateGatewayParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateGatewayParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create gateway params
func (o *CreateGatewayParams) SetXIdempotencyKey(xIdempotencyKey *string) {
