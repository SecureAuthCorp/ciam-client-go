...
// WithXCorrelationID adds the xCorrelationID to the bind group to service params
func (o *BindGroupToServiceParams) WithXCorrelationID(xCorrelationID *string) *BindGroupToServiceParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the bind group to service params
func (o *BindGroupToServiceParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the bind group to service params
func (o *BindGroupToServiceParams) WithXIdempotencyKey(xIdempotencyKey *string) *BindGroupToServiceParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the bind group to service params
func (o *BindGroupToServiceParams) SetXIdempotencyKey(xIdempotencyKey *string) {
