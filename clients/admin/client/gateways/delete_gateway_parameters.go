...
// WithXCorrelationID adds the xCorrelationID to the delete gateway params
func (o *DeleteGatewayParams) WithXCorrelationID(xCorrelationID *string) *DeleteGatewayParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete gateway params
func (o *DeleteGatewayParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete gateway params
func (o *DeleteGatewayParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteGatewayParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete gateway params
func (o *DeleteGatewayParams) SetXIdempotencyKey(xIdempotencyKey *string) {
