...
// WithXCorrelationID adds the xCorrelationID to the get gateway params
func (o *GetGatewayParams) WithXCorrelationID(xCorrelationID *string) *GetGatewayParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get gateway params
func (o *GetGatewayParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get gateway params
func (o *GetGatewayParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetGatewayParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get gateway params
func (o *GetGatewayParams) SetXIdempotencyKey(xIdempotencyKey *string) {
