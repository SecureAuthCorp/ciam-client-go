...
// WithXCorrelationID adds the xCorrelationID to the list policies params
func (o *ListPoliciesParams) WithXCorrelationID(xCorrelationID *string) *ListPoliciesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list policies params
func (o *ListPoliciesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list policies params
func (o *ListPoliciesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListPoliciesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list policies params
func (o *ListPoliciesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
