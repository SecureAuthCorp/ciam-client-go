...
// WithXCorrelationID adds the xCorrelationID to the test policy params
func (o *TestPolicyParams) WithXCorrelationID(xCorrelationID *string) *TestPolicyParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the test policy params
func (o *TestPolicyParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the test policy params
func (o *TestPolicyParams) WithXIdempotencyKey(xIdempotencyKey *string) *TestPolicyParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the test policy params
func (o *TestPolicyParams) SetXIdempotencyKey(xIdempotencyKey *string) {
