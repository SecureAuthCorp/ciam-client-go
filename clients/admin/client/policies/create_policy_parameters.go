...
// WithXCorrelationID adds the xCorrelationID to the create policy params
func (o *CreatePolicyParams) WithXCorrelationID(xCorrelationID *string) *CreatePolicyParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create policy params
func (o *CreatePolicyParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create policy params
func (o *CreatePolicyParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreatePolicyParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create policy params
func (o *CreatePolicyParams) SetXIdempotencyKey(xIdempotencyKey *string) {
