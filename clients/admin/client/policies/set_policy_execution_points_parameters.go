...
// WithXCorrelationID adds the xCorrelationID to the set policy execution points params
func (o *SetPolicyExecutionPointsParams) WithXCorrelationID(xCorrelationID *string) *SetPolicyExecutionPointsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set policy execution points params
func (o *SetPolicyExecutionPointsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set policy execution points params
func (o *SetPolicyExecutionPointsParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetPolicyExecutionPointsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set policy execution points params
func (o *SetPolicyExecutionPointsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
