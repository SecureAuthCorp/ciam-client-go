...
// WithXCorrelationID adds the xCorrelationID to the delete policy params
func (o *DeletePolicyParams) WithXCorrelationID(xCorrelationID *string) *DeletePolicyParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete policy params
func (o *DeletePolicyParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete policy params
func (o *DeletePolicyParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeletePolicyParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete policy params
func (o *DeletePolicyParams) SetXIdempotencyKey(xIdempotencyKey *string) {
