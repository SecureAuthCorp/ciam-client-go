...
// WithXCorrelationID adds the xCorrelationID to the set brute force limit params
func (o *SetBruteForceLimitParams) WithXCorrelationID(xCorrelationID *string) *SetBruteForceLimitParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set brute force limit params
func (o *SetBruteForceLimitParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set brute force limit params
func (o *SetBruteForceLimitParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetBruteForceLimitParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set brute force limit params
func (o *SetBruteForceLimitParams) SetXIdempotencyKey(xIdempotencyKey *string) {
