...
// WithXCorrelationID adds the xCorrelationID to the delete a c r params
func (o *DeleteACRParams) WithXCorrelationID(xCorrelationID *string) *DeleteACRParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete a c r params
func (o *DeleteACRParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete a c r params
func (o *DeleteACRParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteACRParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete a c r params
func (o *DeleteACRParams) SetXIdempotencyKey(xIdempotencyKey *string) {
