...
// WithXCorrelationID adds the xCorrelationID to the get a c r params
func (o *GetACRParams) WithXCorrelationID(xCorrelationID *string) *GetACRParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get a c r params
func (o *GetACRParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get a c r params
func (o *GetACRParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetACRParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get a c r params
func (o *GetACRParams) SetXIdempotencyKey(xIdempotencyKey *string) {
