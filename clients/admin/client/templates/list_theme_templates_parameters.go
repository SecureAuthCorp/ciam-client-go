...
// WithXCorrelationID adds the xCorrelationID to the list theme templates params
func (o *ListThemeTemplatesParams) WithXCorrelationID(xCorrelationID *string) *ListThemeTemplatesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list theme templates params
func (o *ListThemeTemplatesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list theme templates params
func (o *ListThemeTemplatesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListThemeTemplatesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list theme templates params
func (o *ListThemeTemplatesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
