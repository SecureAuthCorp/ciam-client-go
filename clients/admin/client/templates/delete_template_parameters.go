...
// WithXCorrelationID adds the xCorrelationID to the delete template params
func (o *DeleteTemplateParams) WithXCorrelationID(xCorrelationID *string) *DeleteTemplateParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete template params
func (o *DeleteTemplateParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete template params
func (o *DeleteTemplateParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteTemplateParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete template params
func (o *DeleteTemplateParams) SetXIdempotencyKey(xIdempotencyKey *string) {
