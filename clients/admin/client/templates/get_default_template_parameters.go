...
// WithXCorrelationID adds the xCorrelationID to the get default template params
func (o *GetDefaultTemplateParams) WithXCorrelationID(xCorrelationID *string) *GetDefaultTemplateParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get default template params
func (o *GetDefaultTemplateParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get default template params
func (o *GetDefaultTemplateParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetDefaultTemplateParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get default template params
func (o *GetDefaultTemplateParams) SetXIdempotencyKey(xIdempotencyKey *string) {
