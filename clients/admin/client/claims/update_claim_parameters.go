...
// WithXCorrelationID adds the xCorrelationID to the update claim params
func (o *UpdateClaimParams) WithXCorrelationID(xCorrelationID *string) *UpdateClaimParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update claim params
func (o *UpdateClaimParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update claim params
func (o *UpdateClaimParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateClaimParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update claim params
func (o *UpdateClaimParams) SetXIdempotencyKey(xIdempotencyKey *string) {
