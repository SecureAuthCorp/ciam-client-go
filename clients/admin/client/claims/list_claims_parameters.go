...
// WithXCorrelationID adds the xCorrelationID to the list claims params
func (o *ListClaimsParams) WithXCorrelationID(xCorrelationID *string) *ListClaimsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list claims params
func (o *ListClaimsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list claims params
func (o *ListClaimsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListClaimsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list claims params
func (o *ListClaimsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
