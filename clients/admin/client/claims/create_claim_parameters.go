...
// WithXCorrelationID adds the xCorrelationID to the create claim params
func (o *CreateClaimParams) WithXCorrelationID(xCorrelationID *string) *CreateClaimParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the create claim params
func (o *CreateClaimParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the create claim params
func (o *CreateClaimParams) WithXIdempotencyKey(xIdempotencyKey *string) *CreateClaimParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the create claim params
func (o *CreateClaimParams) SetXIdempotencyKey(xIdempotencyKey *string) {
