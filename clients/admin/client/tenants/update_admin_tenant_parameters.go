...
// WithXCorrelationID adds the xCorrelationID to the update admin tenant params
func (o *UpdateAdminTenantParams) WithXCorrelationID(xCorrelationID *string) *UpdateAdminTenantParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the update admin tenant params
func (o *UpdateAdminTenantParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the update admin tenant params
func (o *UpdateAdminTenantParams) WithXIdempotencyKey(xIdempotencyKey *string) *UpdateAdminTenantParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the update admin tenant params
func (o *UpdateAdminTenantParams) SetXIdempotencyKey(xIdempotencyKey *string) {
