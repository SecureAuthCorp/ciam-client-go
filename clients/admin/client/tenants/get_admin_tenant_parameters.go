...
// WithXCorrelationID adds the xCorrelationID to the get admin tenant params
func (o *GetAdminTenantParams) WithXCorrelationID(xCorrelationID *string) *GetAdminTenantParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get admin tenant params
func (o *GetAdminTenantParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get admin tenant params
func (o *GetAdminTenantParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAdminTenantParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get admin tenant params
func (o *GetAdminTenantParams) SetXIdempotencyKey(xIdempotencyKey *string) {
