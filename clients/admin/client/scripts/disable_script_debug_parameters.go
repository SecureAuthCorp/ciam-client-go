...
// WithXCorrelationID adds the xCorrelationID to the disable script debug params
func (o *DisableScriptDebugParams) WithXCorrelationID(xCorrelationID *string) *DisableScriptDebugParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the disable script debug params
func (o *DisableScriptDebugParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the disable script debug params
func (o *DisableScriptDebugParams) WithXIdempotencyKey(xIdempotencyKey *string) *DisableScriptDebugParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the disable script debug params
func (o *DisableScriptDebugParams) SetXIdempotencyKey(xIdempotencyKey *string) {
