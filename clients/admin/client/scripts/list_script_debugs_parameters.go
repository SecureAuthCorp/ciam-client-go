...
// WithXCorrelationID adds the xCorrelationID to the list script debugs params
func (o *ListScriptDebugsParams) WithXCorrelationID(xCorrelationID *string) *ListScriptDebugsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list script debugs params
func (o *ListScriptDebugsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list script debugs params
func (o *ListScriptDebugsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListScriptDebugsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list script debugs params
func (o *ListScriptDebugsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
