...
// WithXCorrelationID adds the xCorrelationID to the list script execution points params
func (o *ListScriptExecutionPointsParams) WithXCorrelationID(xCorrelationID *string) *ListScriptExecutionPointsParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list script execution points params
func (o *ListScriptExecutionPointsParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list script execution points params
func (o *ListScriptExecutionPointsParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListScriptExecutionPointsParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list script execution points params
func (o *ListScriptExecutionPointsParams) SetXIdempotencyKey(xIdempotencyKey *string) {
