...
// WithXCorrelationID adds the xCorrelationID to the get script debug params
func (o *GetScriptDebugParams) WithXCorrelationID(xCorrelationID *string) *GetScriptDebugParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get script debug params
func (o *GetScriptDebugParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get script debug params
func (o *GetScriptDebugParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetScriptDebugParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get script debug params
func (o *GetScriptDebugParams) SetXIdempotencyKey(xIdempotencyKey *string) {
