...
// WithXCorrelationID adds the xCorrelationID to the test script params
func (o *TestScriptParams) WithXCorrelationID(xCorrelationID *string) *TestScriptParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the test script params
func (o *TestScriptParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the test script params
func (o *TestScriptParams) WithXIdempotencyKey(xIdempotencyKey *string) *TestScriptParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the test script params
func (o *TestScriptParams) SetXIdempotencyKey(xIdempotencyKey *string) {
