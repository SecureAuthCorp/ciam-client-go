...
// WithXCorrelationID adds the xCorrelationID to the remove specification params
func (o *RemoveSpecificationParams) WithXCorrelationID(xCorrelationID *string) *RemoveSpecificationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the remove specification params
func (o *RemoveSpecificationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the remove specification params
func (o *RemoveSpecificationParams) WithXIdempotencyKey(xIdempotencyKey *string) *RemoveSpecificationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the remove specification params
func (o *RemoveSpecificationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
