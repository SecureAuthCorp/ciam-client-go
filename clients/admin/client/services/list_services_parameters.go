...
// WithXCorrelationID adds the xCorrelationID to the list services params
func (o *ListServicesParams) WithXCorrelationID(xCorrelationID *string) *ListServicesParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the list services params
func (o *ListServicesParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the list services params
func (o *ListServicesParams) WithXIdempotencyKey(xIdempotencyKey *string) *ListServicesParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the list services params
func (o *ListServicesParams) SetXIdempotencyKey(xIdempotencyKey *string) {
