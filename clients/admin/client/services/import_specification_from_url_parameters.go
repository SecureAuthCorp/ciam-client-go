...
// WithXCorrelationID adds the xCorrelationID to the import specification from URL params
func (o *ImportSpecificationFromURLParams) WithXCorrelationID(xCorrelationID *string) *ImportSpecificationFromURLParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the import specification from URL params
func (o *ImportSpecificationFromURLParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the import specification from URL params
func (o *ImportSpecificationFromURLParams) WithXIdempotencyKey(xIdempotencyKey *string) *ImportSpecificationFromURLParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the import specification from URL params
func (o *ImportSpecificationFromURLParams) SetXIdempotencyKey(xIdempotencyKey *string) {
