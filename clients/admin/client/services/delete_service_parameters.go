...
// WithXCorrelationID adds the xCorrelationID to the delete service params
func (o *DeleteServiceParams) WithXCorrelationID(xCorrelationID *string) *DeleteServiceParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the delete service params
func (o *DeleteServiceParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the delete service params
func (o *DeleteServiceParams) WithXIdempotencyKey(xIdempotencyKey *string) *DeleteServiceParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the delete service params
func (o *DeleteServiceParams) SetXIdempotencyKey(xIdempotencyKey *string) {
