...
// WithXCorrelationID adds the xCorrelationID to the get automatic key rotation params
func (o *GetAutomaticKeyRotationParams) WithXCorrelationID(xCorrelationID *string) *GetAutomaticKeyRotationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get automatic key rotation params
func (o *GetAutomaticKeyRotationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get automatic key rotation params
func (o *GetAutomaticKeyRotationParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetAutomaticKeyRotationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get automatic key rotation params
func (o *GetAutomaticKeyRotationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
