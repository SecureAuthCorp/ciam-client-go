...
// WithXCorrelationID adds the xCorrelationID to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) WithXCorrelationID(xCorrelationID *string) *SetAutomaticKeyRotationParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) WithXIdempotencyKey(xIdempotencyKey *string) *SetAutomaticKeyRotationParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) SetXIdempotencyKey(xIdempotencyKey *string) {
