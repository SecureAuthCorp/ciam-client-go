...
// WithXCorrelationID adds the xCorrelationID to the get keys params
func (o *GetKeysParams) WithXCorrelationID(xCorrelationID *string) *GetKeysParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get keys params
func (o *GetKeysParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get keys params
func (o *GetKeysParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetKeysParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get keys params
func (o *GetKeysParams) SetXIdempotencyKey(xIdempotencyKey *string) {
