...
// WithXCorrelationID adds the xCorrelationID to the get key params
func (o *GetKeyParams) WithXCorrelationID(xCorrelationID *string) *GetKeyParams {
	o.SetXCorrelationID(xCorrelationID)
	return o
}

// SetXCorrelationID adds the xCorrelationId to the get key params
func (o *GetKeyParams) SetXCorrelationID(xCorrelationID *string) {
	o.XCorrelationID = xCorrelationID
}

// WithXIdempotencyKey adds the xIdempotencyKey to the get key params
func (o *GetKeyParams) WithXIdempotencyKey(xIdempotencyKey *string) *GetKeyParams {
	o.SetXIdempotencyKey(xIdempotencyKey)
	return o
}

// SetXIdempotencyKey adds the xIdempotencyKey to the get key params
func (o *GetKeyParams) SetXIdempotencyKey(xIdempotencyKey *string) {
