...
type WorkspaceResponse struct {
	...
	// number of clients
	NumberOfClients int64 `json:"number_of_clients,omitempty" yaml:"number_of_clients,omitempty"`

	// number of idps excluding organization
	NumberOfIdpsExcludingOrganization int64 `json:"number_of_idps_excluding_organization,omitempty" yaml:"number_of_idps_excluding_organization,omitempty"`

	// number of services
	NumberOfServices int64 `json:"number_of_services,omitempty" yaml:"number_of_services,omitempty"`
...
const (
	...
	// WorkspaceResponseProfileSaidpLegacy captures enum value "saidp_legacy"
	WorkspaceResponseProfileSaidpLegacy string = "saidp_legacy"
)
