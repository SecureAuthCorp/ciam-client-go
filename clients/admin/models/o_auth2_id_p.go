...
// OAuth2IDP o auth2 ID p
//
// swagger:model OAuth2IDP
type OAuth2IDP struct {
	...
	// credentials
	Credentials *OAuth2Credentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *OAuth2Settings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this o auth2 ID p
func (m *OAuth2IDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2IDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateConfig(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateJit(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateMappings(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateSettings(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *OAuth2IDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this o auth2 ID p based on the context it is used
func (m *OAuth2IDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2IDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2IDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OAuth2IDP) UnmarshalBinary(b []byte) error {
	var res OAuth2IDP
