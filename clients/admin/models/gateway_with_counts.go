...
// GatewayWithCounts gateway with counts
//
// swagger:model GatewayWithCounts
type GatewayWithCounts struct {
	...
	// number of api groups bound to a service
	NumberOfApisWithConnectedServices int64 `json:"number_of_apis_with_connected_services,omitempty" yaml:"number_of_apis_with_connected_services,omitempty"`

	// number of api groups not bound to any service
	NumberOfApisWithoutConnectedServices int64 `json:"number_of_apis_without_connected_services,omitempty" yaml:"number_of_apis_without_connected_services,omitempty"`

	// number of services connected to this gateway
	NumberOfServicesWithConnectedGateway int64 `json:"number_of_services_with_connected_gateway,omitempty" yaml:"number_of_services_with_connected_gateway,omitempty"`
...
// Validate validates this gateway with counts
func (m *GatewayWithCounts) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GatewayWithCounts) validateLastActive(formats strfmt.Registry) error {
...
func (m *GatewayWithCounts) validateTokenExchange(formats strfmt.Registry) error {
...
// ContextValidate validate this gateway with counts based on the context it is used
func (m *GatewayWithCounts) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GatewayWithCounts) contextValidateTokenExchange(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GatewayWithCounts) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GatewayWithCounts) UnmarshalBinary(b []byte) error {
	var res GatewayWithCounts
