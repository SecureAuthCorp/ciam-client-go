...
func (m *Translations) validateTranslations(formats strfmt.Registry) error {
...
// ContextValidate validate this translations based on the context it is used
...
func (m *Translations) contextValidateTranslations(ctx context.Context, formats strfmt.Registry) error {
