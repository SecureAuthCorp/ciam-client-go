...
// OktaV2IDP okta v2 ID p
//
// swagger:model OktaV2IDP
type OktaV2IDP struct {
	...
	// credentials
	Credentials *OktaV2Credentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *OktaV2Settings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this okta v2 ID p
func (m *OktaV2IDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OktaV2IDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateConfig(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateCredentials(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateJit(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateMappings(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateSettings(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *OktaV2IDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this okta v2 ID p based on the context it is used
func (m *OktaV2IDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OktaV2IDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OktaV2IDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OktaV2IDP) UnmarshalBinary(b []byte) error {
	var res OktaV2IDP
