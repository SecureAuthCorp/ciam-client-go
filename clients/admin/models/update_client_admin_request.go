...
func (m *UpdateClientAdminRequest) validateAgentCapability(formats strfmt.Registry) error {
...
var updateClientAdminRequestTypeApplicationPurposePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateClientAdminRequestTypeApplicationPurposePropEnum = append(updateClientAdminRequestTypeApplicationPurposePropEnum, v)
	}
}

const (

	// UpdateClientAdminRequestApplicationPurposeSinglePage captures enum value "single_page"
	UpdateClientAdminRequestApplicationPurposeSinglePage string = "single_page"

	// UpdateClientAdminRequestApplicationPurposeServerWeb captures enum value "server_web"
	UpdateClientAdminRequestApplicationPurposeServerWeb string = "server_web"

	// UpdateClientAdminRequestApplicationPurposeMobileDesktop captures enum value "mobile_desktop"
	UpdateClientAdminRequestApplicationPurposeMobileDesktop string = "mobile_desktop"

	// UpdateClientAdminRequestApplicationPurposeService captures enum value "service"
	UpdateClientAdminRequestApplicationPurposeService string = "service"

	// UpdateClientAdminRequestApplicationPurposeLegacy captures enum value "legacy"
	UpdateClientAdminRequestApplicationPurposeLegacy string = "legacy"

	// UpdateClientAdminRequestApplicationPurposeCustom captures enum value "custom"
	UpdateClientAdminRequestApplicationPurposeCustom string = "custom"

	// UpdateClientAdminRequestApplicationPurposeSaml captures enum value "saml"
	UpdateClientAdminRequestApplicationPurposeSaml string = "saml"

	// UpdateClientAdminRequestApplicationPurposeAiAgent captures enum value "ai_agent"
	UpdateClientAdminRequestApplicationPurposeAiAgent string = "ai_agent"
)

// prop value enum
func (m *UpdateClientAdminRequest) validateApplicationPurposeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateClientAdminRequestTypeApplicationPurposePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdateClientAdminRequest) validateApplicationPurpose(formats strfmt.Registry) error {
...
func (m *UpdateClientAdminRequest) validateSamlIdpAttributesOverride(formats strfmt.Registry) error {
...
func (m *UpdateClientAdminRequest) validateSamlIdpSigningKey(formats strfmt.Registry) error {
...
func (m *UpdateClientAdminRequest) contextValidateAgentCapability(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateClientAdminRequest) contextValidateSamlIdpAttributesOverride(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateClientAdminRequest) contextValidateSamlIdpSigningKey(ctx context.Context, formats strfmt.Registry) error {
