...
func (m *Gateways) validateGateways(formats strfmt.Registry) error {
...
func (m *Gateways) contextValidateGateways(ctx context.Context, formats strfmt.Registry) error {
