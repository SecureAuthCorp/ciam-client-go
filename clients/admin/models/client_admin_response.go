...
func (m *ClientAdminResponse) validateAgentCapability(formats strfmt.Registry) error {
...
var clientAdminResponseTypeApplicationPurposePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		clientAdminResponseTypeApplicationPurposePropEnum = append(clientAdminResponseTypeApplicationPurposePropEnum, v)
	}
}

const (

	// ClientAdminResponseApplicationPurposeSinglePage captures enum value "single_page"
	ClientAdminResponseApplicationPurposeSinglePage string = "single_page"

	// ClientAdminResponseApplicationPurposeServerWeb captures enum value "server_web"
	ClientAdminResponseApplicationPurposeServerWeb string = "server_web"

	// ClientAdminResponseApplicationPurposeMobileDesktop captures enum value "mobile_desktop"
	ClientAdminResponseApplicationPurposeMobileDesktop string = "mobile_desktop"

	// ClientAdminResponseApplicationPurposeService captures enum value "service"
	ClientAdminResponseApplicationPurposeService string = "service"

	// ClientAdminResponseApplicationPurposeLegacy captures enum value "legacy"
	ClientAdminResponseApplicationPurposeLegacy string = "legacy"

	// ClientAdminResponseApplicationPurposeCustom captures enum value "custom"
	ClientAdminResponseApplicationPurposeCustom string = "custom"

	// ClientAdminResponseApplicationPurposeSaml captures enum value "saml"
	ClientAdminResponseApplicationPurposeSaml string = "saml"

	// ClientAdminResponseApplicationPurposeAiAgent captures enum value "ai_agent"
	ClientAdminResponseApplicationPurposeAiAgent string = "ai_agent"
)

// prop value enum
func (m *ClientAdminResponse) validateApplicationPurposeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clientAdminResponseTypeApplicationPurposePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClientAdminResponse) validateApplicationPurpose(formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) validateSamlIdpAttributesOverride(formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) validateSamlIdpSigningKey(formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) validateSamlMetadataUpdatedAt(formats strfmt.Registry) error {
...
var clientAdminResponseTypeSamlSigningHashPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		clientAdminResponseTypeSamlSigningHashPropEnum = append(clientAdminResponseTypeSamlSigningHashPropEnum, v)
	}
}

const (

	// ClientAdminResponseSamlSigningHashShaDash1 captures enum value "sha-1"
	ClientAdminResponseSamlSigningHashShaDash1 string = "sha-1"

	// ClientAdminResponseSamlSigningHashShaDash256 captures enum value "sha-256"
	ClientAdminResponseSamlSigningHashShaDash256 string = "sha-256"

	// ClientAdminResponseSamlSigningHashShaDash512 captures enum value "sha-512"
	ClientAdminResponseSamlSigningHashShaDash512 string = "sha-512"
)

// prop value enum
func (m *ClientAdminResponse) validateSamlSigningHashEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clientAdminResponseTypeSamlSigningHashPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClientAdminResponse) validateSamlSigningHash(formats strfmt.Registry) error {
...
var clientAdminResponseTypeSamlSubjectNameIDFormatPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		clientAdminResponseTypeSamlSubjectNameIDFormatPropEnum = append(clientAdminResponseTypeSamlSubjectNameIDFormatPropEnum, v)
	}
}

const (

	// ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML1Dot1NameidDashFormatUnspecified captures enum value "urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified"
	ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML1Dot1NameidDashFormatUnspecified string = "urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified"

	// ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML2Dot0NameidDashFormatTransient captures enum value "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"
	ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML2Dot0NameidDashFormatTransient string = "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"

	// ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML1Dot1NameidDashFormatEmailAddress captures enum value "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"
	ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML1Dot1NameidDashFormatEmailAddress string = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"

	// ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML2Dot0NameidDashFormatPersistent captures enum value "urn:oasis:names:tc:SAML:2.0:nameid-format:persistent"
	ClientAdminResponseSamlSubjectNameIDFormatUrnOasisNamesTcSAML2Dot0NameidDashFormatPersistent string = "urn:oasis:names:tc:SAML:2.0:nameid-format:persistent"
)

// prop value enum
func (m *ClientAdminResponse) validateSamlSubjectNameIDFormatEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clientAdminResponseTypeSamlSubjectNameIDFormatPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClientAdminResponse) validateSamlSubjectNameIDFormat(formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) contextValidateAgentCapability(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) contextValidateSamlIdpAttributesOverride(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClientAdminResponse) contextValidateSamlIdpSigningKey(ctx context.Context, formats strfmt.Registry) error {
