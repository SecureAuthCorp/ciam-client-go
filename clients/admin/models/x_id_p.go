...
type XIDP struct {
	...
	// settings
	Settings *XSettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this x ID p
func (m *XIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *XIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *XIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *XIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *XIDP) validateJit(formats strfmt.Registry) error {
...
func (m *XIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *XIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *XIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *XIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this x ID p based on the context it is used
func (m *XIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *XIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *XIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *XIDP) UnmarshalBinary(b []byte) error {
	var res XIDP
