...
func (m *ImportServiceConfigurationResult) validateCapabilities(formats strfmt.Registry) error {
...
func (m *ImportServiceConfigurationResult) contextValidateCapabilities(ctx context.Context, formats strfmt.Registry) error {
