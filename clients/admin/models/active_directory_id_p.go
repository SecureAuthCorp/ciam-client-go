...
// ActiveDirectoryIDP active directory ID p
//
// swagger:model ActiveDirectoryIDP
type ActiveDirectoryIDP struct {
	...
	// credentials
	Credentials ActiveDirectoryCredentials `json:"credentials,omitempty" yaml:"credentials,omitempty"`
	...
	// settings
	Settings *ActiveDirectorySettings `json:"settings,omitempty" yaml:"settings,omitempty"`
...
// Validate validates this active directory ID p
func (m *ActiveDirectoryIDP) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ActiveDirectoryIDP) validateAttributes(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateConfig(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateDiscoverySettings(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateJit(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateMappings(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateSettings(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateSsoSettings(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) validateTokenExchangeSettings(formats strfmt.Registry) error {
...
// ContextValidate validate this active directory ID p based on the context it is used
func (m *ActiveDirectoryIDP) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ActiveDirectoryIDP) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateDiscoverySettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateJit(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateSsoSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) contextValidateTokenExchangeSettings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ActiveDirectoryIDP) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ActiveDirectoryIDP) UnmarshalBinary(b []byte) error {
	var res ActiveDirectoryIDP
