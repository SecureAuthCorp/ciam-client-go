...
func (m *ServiceResponse) validateCapabilities(formats strfmt.Registry) error {
...
func (m *ServiceResponse) contextValidateCapabilities(ctx context.Context, formats strfmt.Registry) error {
