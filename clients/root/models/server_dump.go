...
var serverDumpAuthenticationMechanismsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serverDumpAuthenticationMechanismsItemsEnum = append(serverDumpAuthenticationMechanismsItemsEnum, v)
	}
}

func (m *ServerDump) validateAuthenticationMechanismsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, serverDumpAuthenticationMechanismsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ServerDump) validateAuthenticationMechanisms(formats strfmt.Registry) error {
...
const (
	...
	ServerDumpProfileOpenbankingBrUnico string = "openbanking_br_unico"
	...
	// ServerDumpProfileSaidpLegacy captures enum value "saidp_legacy"
	ServerDumpProfileSaidpLegacy string = "saidp_legacy"
)
...
func (m *ServerDump) validateScopeClaimFormats(formats strfmt.Registry) error {
...
func (m *ServerDump) contextValidateScopeClaimFormats(ctx context.Context, formats strfmt.Registry) error {
