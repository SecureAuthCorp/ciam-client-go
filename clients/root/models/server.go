...
func (m *Server) validatePreferences(formats strfmt.Registry) error {
...
const (
	...
	// ServerProfileAgenticAi captures enum value "agentic_ai"
	ServerProfileAgenticAi string = "agentic_ai"

	// ServerProfileSaidpLegacy captures enum value "saidp_legacy"
	ServerProfileSaidpLegacy string = "saidp_legacy"
)
...
func (m *Server) contextValidatePreferences(ctx context.Context, formats strfmt.Registry) error {
