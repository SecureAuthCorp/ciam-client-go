...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateApis(formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateAuthorizationDetails(formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateScopes(formats strfmt.Registry) error {
...
var serviceWithScopesAndAPIsAndAuthorizationDetailsTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceWithScopesAndAPIsAndAuthorizationDetailsTypeTypePropEnum = append(serviceWithScopesAndAPIsAndAuthorizationDetailsTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, serviceWithScopesAndAPIsAndAuthorizationDetailsTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateType(formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) contextValidateApis(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) contextValidateAuthorizationDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) contextValidateScopes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ServiceWithScopesAndAPIsAndAuthorizationDetails) UnmarshalBinary(b []byte) error {
	var res ServiceWithScopesAndAPIsAndAuthorizationDetails
