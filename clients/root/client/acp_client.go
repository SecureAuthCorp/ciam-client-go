...
import (
	...
	"github.com/cloudentity/acp-client-go/clients/root/client/workforce"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Acp {
	...
	cli.Workforce = workforce.New(transport, formats)
...
type Acp struct {
	...
	Workforce workforce.ClientService
...
func (c *Acp) SetTransport(transport runtime.ClientTransport) {
	...
	c.Workforce.SetTransport(transport)
